...
#ifndef C_VDL_hashmap_DEFINED
#define C_VDL_hashmap_DEFINED
...
class C_VDL_hashmap {
//--- Constructor
  public : C_VDL_hashmap (void) ;

//--- Destructor
  public : virtual ~C_VDL_hashmap (void) ;

//--- Search or insert
  public : C_activitiesToSchedule::cVDLnodeInfo * search_or_insert (const C_activitiesToSchedule::cVDLnodeInfo & inInfo,
...
//--- No copy
  ...
  private : void operator = (const C_VDL_hashmap &) ;
...
//--- Internal methods
  ...
  protected : C_activitiesToSchedule::cVDLnodeInfo * avltree_search (MyBlockavltree_element_for_collision * ioRootPointer,
                                                       const C_activitiesToSchedule::cVDLnodeInfo & inInfo) ;

  protected : C_activitiesToSchedule::cVDLnodeInfo * recursiveSearchOrInsert (MyBlockavltree_element_for_collision * & ioRootPointer,
                                                             const C_activitiesToSchedule::cVDLnodeInfo & inInfo,
                                                             bool & outExtension,
                                                             bool & outInsertionPerformed) ;
