...
static const PMSInt32 BLOCK_SIZE = 131072 ;

//---------------------------------------------------------------------------*

C_us_hashmap::cAllocInfo C_us_hashmap::smAllocInfo ;
...
void * C_us_hashmap::MyBlockavltree_element_for_collision::operator new (const size_t /*inByteSize*/) {
...
void C_us_hashmap::MyBlockavltree_element_for_collision::operator delete (void * inPtr) {
...
//--- Align pointer
  if ((((PMSInt) ptr) % ALIGNMENT) != 0) {
    ptr = (char *) (((((PMSInt) ptr) / ALIGNMENT) + 1) * ALIGNMENT) ;
    blockSize -= ALIGNMENT ;
  }
...
PMUInt32 C_us_hashmap::getAllocatedSizeInBytes (void) {
...
C_us::C_us_nodeInfo * C_us_hashmap::C_TreeForCollision::
search_or_insert (const C_us::C_us_nodeInfo & inInfo,
                  bool & outInsertionPerformed) {
  bool unused = false ;
...
C_us::C_us_nodeInfo * C_us_hashmap::C_TreeForCollision::
search (const C_us::C_us_nodeInfo & inInfo) {
...
PMUInt32 C_us_hashmap::C_TreeForCollision::internalRecursiveSweep (C_us_hashmap::MyBlockavltree_element_for_collision * inElement) {
...
PMUInt32 C_us_hashmap::C_TreeForCollision::sweepUnmarkedObjects (void) {
...
PMSInt32 C_us_hashmap::C_TreeForCollision::
...
C_us_hashmap::~C_us_hashmap (void) {
...
C_us::C_us_nodeInfo * C_us_hashmap::
search_or_insert (const C_us::C_us_nodeInfo & inInfo,
                  bool & outInsertionPerformed) {
...
PMUInt32 C_us_hashmap::sweepUnmarkedObjects (void) {
  PMUInt32 sweepedNodes = 0 ;
...
PMUInt32 C_us_hashmap::getMapSizeInBytes (void) const {
...
PMSInt32 C_us_hashmap::getMarkedNodesCount (void) const {
  PMSInt32 count = 0 ;
  for (PMSInt32 i=0 ; i<mEntryCurrentCount ; i++) {
