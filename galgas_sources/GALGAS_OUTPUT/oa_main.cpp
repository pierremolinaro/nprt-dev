...
static void
oa_main_prologue (C_Compiler & /* _inLexique */,
...
static void
oa_main_epilogue (C_Compiler & /* _inLexique */,
                     const TC_UniqueArray <C_String> & /* inSourceFilesArray */) {
}
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("nprt") == 0) {
            ...
            oa_grammar::_performSourceFileParsing_ (_inLexique,
                                            GGS_string (true, ""),
                                            NULL,
