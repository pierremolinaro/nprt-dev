...
static void
oa_main_prologue (C_CompilerEx & /* inLexique */,
...
static void
oa_main_epilogue (C_CompilerEx & /* inLexique */,
                     const TC_UniqueArray <C_String> & /* inSourceFilesArray */) {
}
...
int mainForLIBPM  (const int argc, const char * argv []) {
  ...
  //--- Enable 64 bit alloc debug ? Only if compiled in 64 bit and in debug mode
    ...
    try{
      ...
      oa_main_prologue (* commonLexique, sourceFilesArray) ;
    ...
    //--- Epilogue
      oa_main_epilogue (* commonLexique, sourceFilesArray) ;
