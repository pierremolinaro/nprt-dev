      ...
      switch (select_repeat_oa_parser_0 (_inLexique)) {
        case 2 : {
          ...
          switch (select_oa_parser_1 (_inLexique)) {
            case 1 : {
              var_cas_step = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 1), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            case 2 : {
              ...
              if (((var_cas_step.reader_value (_inLexique SOURCE_FILE_AT_LINE (189))) == (GGS_uint (true, 0))).isBuiltAndTrue ()) {
        ...
        case 3 : {
          ...
          switch (select_oa_parser_3 (_inLexique)) {
            case 1 : {
              var_cas_factor = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 1), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (oa_scanner::oa_scanner_1_scalingfactor) ;
              _inLexique.acceptTerminal (oa_scanner::oa_scanner_1_literal_5Finteger) ;
              var_cas_factor.defineAttribute (_inLexique.ulongValue, _inLexique) ;
              if (((var_cas_factor.reader_value (_inLexique SOURCE_FILE_AT_LINE (213))) == (GGS_uint (true, 0))).isBuiltAndTrue ()) {
        ...
        case 4 : {
          ...
          switch (select_oa_parser_4 (_inLexique)) {
            ...
            case 2 : {
              var_cas_taskOffset = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 0), GGS_location (_inLexique) COMMA_HERE) ;
          ...
          switch (select_oa_parser_5 (_inLexique)) {
            ...
            case 2 : {
              var_cas_taskDeadline = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 4294967295), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            default :
              break ;
          }
              ...
              switch (select_oa_parser_7 (_inLexique)) {
                case 1 : {
                  ...
                  switch (select_oa_parser_8 (_inLexique)) {
                    case 1 : {
                      var_cas_every = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 1), GGS_location (_inLexique) COMMA_HERE) ;
                      } break ;
                    case 2 : {
        ...
        case 5 : {
          ...
          switch (select_oa_parser_10 (_inLexique)) {
            case 1 : {
              ...
              var_cas_messageClass = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 0), GGS_location (_inLexique) COMMA_HERE) ;
              _inLexique.acceptTerminal (oa_scanner::oa_scanner_1_message) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (oa_scanner::oa_scanner_1_extended) ;
              var_cas_messageClass = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 1), GGS_location (_inLexique) COMMA_HERE) ;
              _inLexique.acceptTerminal (oa_scanner::oa_scanner_1_message) ;
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (oa_scanner::oa_scanner_1_message) ;
              var_cas_messageClass = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 2), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            default :
              break ;
          }
          ...
          if ((((var_cas_CANnetwork) & ((var_cas_messageClass.reader_value (_inLexique SOURCE_FILE_AT_LINE (330))) == (GGS_uint (true, 2))))).isBuiltAndTrue ()) {
          ...
          }else if (((((! (var_cas_CANnetwork))) & ((var_cas_messageClass.reader_value (_inLexique SOURCE_FILE_AT_LINE (332))) != (GGS_uint (true, 2))))).isBuiltAndTrue ()) {
          ...
          if ((((var_cas_CANnetwork) & ((var_cas_bytesCount.reader_value (_inLexique SOURCE_FILE_AT_LINE (338))) > (GGS_uint (true, 8))))).isBuiltAndTrue ()) {
          ...
          }else if (((((! (var_cas_CANnetwork))) & ((var_cas_bytesCount.reader_value (_inLexique SOURCE_FILE_AT_LINE (340))) > (GGS_uint (true, 28))))).isBuiltAndTrue ()) {
          ...
          switch (select_oa_parser_11 (_inLexique)) {
            ...
            case 2 : {
              var_cas_offset = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 0), GGS_location (_inLexique) COMMA_HERE) ;
              var_cas_explicitOffset = GGS_bool (true, false) ;
              } break ;
            default :
              break ;
          ...
          switch (select_oa_parser_12 (_inLexique)) {
            ...
            case 2 : {
              var_cas_deadline = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 4294967295), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            default :
              break ;
          }
