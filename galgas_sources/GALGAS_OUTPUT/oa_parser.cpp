    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_oa_parser_0 (inLexique)) {
        case 2 : {
          ...
          switch (select_oa_parser_1 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_1109 = (var_cas_step.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (31))).operator_isEqual (GGS_uint (0U)) ;
              if (cond_1109.isBuiltAndTrue ()) {
        ...
        case 3 : {
          ...
          switch (select_oa_parser_3 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5F_integer) COMMA_HERE) ;
              const GGS_bool cond_1649 = (var_cas_factor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (55))).operator_isEqual (GGS_uint (0U)) ;
              if (cond_1649.isBuiltAndTrue ()) {
        ...
        case 4 : {
          ...
          switch (select_oa_parser_6 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_2995 = var_cas_explicitOffset ;
              if (cond_2995.isBuiltAndTrue ()) {
        ...
        case 5 : {
          ...
          const GGS_bool cond_5414 = (var_cas_CANnetwork).operator_and ((var_cas_messageClass.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (172))).operator_isEqual (GGS_uint (2U))) ;
          if (cond_5414.isBuiltAndTrue ()) {
          ...
          }else if (cond_5414.isBuiltAndFalse ()) {
            const GGS_bool cond_5549 = ((var_cas_CANnetwork).operator_not ()).operator_and ((var_cas_messageClass.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (174))).operator_isNotEqual (GGS_uint (2U))) ;
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5F_integer) COMMA_HERE) ;
          const GGS_bool cond_5756 = (var_cas_CANnetwork).operator_and ((var_cas_bytesCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (180))).operator_strictSup (GGS_uint (8U))) ;
          ...
          }else if (cond_5756.isBuiltAndFalse ()) {
            const GGS_bool cond_5874 = ((var_cas_CANnetwork).operator_not ()).operator_and ((var_cas_bytesCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (182))).operator_strictSup (GGS_uint (28U))) ;
            if (cond_5874.isBuiltAndTrue ()) {
          ...
          switch (select_oa_parser_13 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_on) COMMA_HERE) ;
              const GGS_bool cond_6647 = var_cas_explicitOffset ;
