    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_oa_parser_0 (inLexique)) {
        case 2 : {
          ...
          inLexique._assignFromAttribute_identifierString (var_cas_processorName) ;
          ...
          switch (select_oa_parser_1 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique._assignFromAttribute_ulongValue (var_cas_step) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
              if (((var_cas_step.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (31)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1__3B) COMMA_HERE) ;
          } break ;
        case 3 : {
          ...
          inLexique._assignFromAttribute_identifierString (var_cas_networkName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_identifier) COMMA_HERE) ;
          ...
          switch (select_oa_parser_3 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_scalingfactor) COMMA_HERE) ;
              inLexique._assignFromAttribute_ulongValue (var_cas_factor) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
              if (((var_cas_factor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (55)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
        ...
        case 4 : {
          ...
          inLexique._assignFromAttribute_identifierString (var_cas_taskName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_identifier) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_priority) COMMA_HERE) ;
          GGS_luint  var_cas_taskPriority ;
          inLexique._assignFromAttribute_ulongValue (var_cas_taskPriority) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_duration) COMMA_HERE) ;
          GGS_luint  var_cas_taskDurationMin ;
          inLexique._assignFromAttribute_ulongValue (var_cas_taskDurationMin) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1__2E_2E) COMMA_HERE) ;
          GGS_luint  var_cas_taskDurationMax ;
          inLexique._assignFromAttribute_ulongValue (var_cas_taskDurationMax) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
          ...
          switch (select_oa_parser_4 (inLexique)) {
            case 1 : {
              ...
              inLexique._assignFromAttribute_ulongValue (var_cas_taskOffset) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
          ...
          switch (select_oa_parser_5 (inLexique)) {
            case 1 : {
              ...
              inLexique._assignFromAttribute_ulongValue (var_cas_taskDeadline) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
              } break ;
            case 2 : {
          ...
          switch (select_oa_parser_6 (inLexique)) {
            case 1 : {
              ...
              inLexique._assignFromAttribute_ulongValue (var_cas_taskPeriod) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_processor) COMMA_HERE) ;
              GGS_lstring  var_cas_taskProcessorName ;
              inLexique._assignFromAttribute_identifierString (var_cas_taskProcessorName) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_identifier) COMMA_HERE) ;
            ...
            case 2 : {
              ...
              switch (select_oa_parser_7 (inLexique)) {
                case 1 : {
                  ...
                  inLexique._assignFromAttribute_identifierString (var_cas_masterTaskName) ;
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_identifier) COMMA_HERE) ;
                  ...
                  switch (select_oa_parser_8 (inLexique)) {
                    ...
                    case 2 : {
                      ...
                      inLexique._assignFromAttribute_ulongValue (var_cas_every) ;
                      inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
                      } break ;
                    default :
                      break ;
                ...
                case 2 : {
                  ...
                  inLexique._assignFromAttribute_identifierString (var_cas_masterMessageName) ;
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_identifier) COMMA_HERE) ;
        ...
        case 5 : {
          ...
          inLexique._assignFromAttribute_identifierString (var_cas_messageName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_identifier) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_network) COMMA_HERE) ;
          GGS_lstring  var_cas_networkName ;
          inLexique._assignFromAttribute_identifierString (var_cas_networkName) ;
          ...
          if (((var_cas_CANnetwork)._operator_and ((var_cas_messageClass.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (172)))._operator_isEqual (GGS_uint (2U)))).isBuiltAndTrue ()) {
          ...
          }else if ((((var_cas_CANnetwork)._operator_not ())._operator_and ((var_cas_messageClass.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (174)))._operator_isNotEqual (GGS_uint (2U)))).isBuiltAndTrue ()) {
          ...
          inLexique._assignFromAttribute_ulongValue (var_cas_bytesCount) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
          if (((var_cas_CANnetwork)._operator_and ((var_cas_bytesCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (180)))._operator_strictSup (GGS_uint (8U)))).isBuiltAndTrue ()) {
          ...
          }else if ((((var_cas_CANnetwork)._operator_not ())._operator_and ((var_cas_bytesCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (182)))._operator_strictSup (GGS_uint (28U)))).isBuiltAndTrue ()) {
          ...
          inLexique._assignFromAttribute_ulongValue (var_cas_priority) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
          ...
          switch (select_oa_parser_11 (inLexique)) {
            case 1 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_offset) COMMA_HERE) ;
              inLexique._assignFromAttribute_ulongValue (var_cas_offset) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
              var_cas_explicitOffset = GGS_bool (true) ;
              } break ;
            case 2 : {
          ...
          switch (select_oa_parser_12 (inLexique)) {
            case 1 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_deadline) COMMA_HERE) ;
              inLexique._assignFromAttribute_ulongValue (var_cas_deadline) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
              } break ;
            case 2 : {
          ...
          switch (select_oa_parser_13 (inLexique)) {
            case 1 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_period) COMMA_HERE) ;
              inLexique._assignFromAttribute_ulongValue (var_cas_period) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
            ...
            case 2 : {
              ...
              switch (select_oa_parser_14 (inLexique)) {
                case 1 : {
                  ...
                  inLexique._assignFromAttribute_identifierString (var_cas_name) ;
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_identifier) COMMA_HERE) ;
