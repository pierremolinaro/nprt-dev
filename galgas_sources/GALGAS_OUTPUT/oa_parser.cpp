...
void oa_parser::
pr_axiome_oa_parser_13_13_ (oa_scanner & _inLexique) {
      ...
      switch (select_repeat_oa_parser_0 (_inLexique)) {
        case 2 : {
          ...
          switch (select_oa_parser_1 (_inLexique)) {
            case 1 : {
              var_cas_step = GGS_luint ::constructor_new (_inLexique, GGS_uint (1U), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            case 2 : {
              ...
              if (((var_cas_step.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (31)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
                var_cas_step.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the step value must be > 0") COMMA_SOURCE_FILE_AT_LINE (33)) ;
              }
              } break ;
            default :
              break ;
        ...
        case 3 : {
          ...
          switch (select_oa_parser_3 (_inLexique)) {
            case 1 : {
              var_cas_factor = GGS_luint ::constructor_new (_inLexique, GGS_uint (1U), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_scalingfactor) COMMA_HERE) ;
              _inLexique._assignFromAttribute_ulongValue (var_cas_factor) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
              if (((var_cas_factor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (55)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
                var_cas_factor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the factor value must be > 0") COMMA_SOURCE_FILE_AT_LINE (57)) ;
              }
              } break ;
            default :
              break ;
        ...
        case 4 : {
          ...
          switch (select_oa_parser_4 (_inLexique)) {
            ...
            case 2 : {
              var_cas_taskOffset = GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) ;
          ...
          switch (select_oa_parser_5 (_inLexique)) {
            ...
            case 2 : {
              var_cas_taskDeadline = GGS_luint ::constructor_new (_inLexique, GGS_uint (4294967295U), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            default :
              break ;
          }
          ...
          switch (select_oa_parser_6 (_inLexique)) {
            case 1 : {
              ...
              if (_temp_2777.isBuilt ()) {
                _temp_2777 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_taskProcessorName, var_cas_taskProcessorIndex, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (100)) ;
              }
            ...
            case 2 : {
              ...
              if ((var_cas_explicitOffset).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("A dependant task cannot have an offset") COMMA_SOURCE_FILE_AT_LINE (106)) ;
              }
              switch (select_oa_parser_7 (_inLexique)) {
                case 1 : {
                  ...
                  switch (select_oa_parser_8 (_inLexique)) {
                    case 1 : {
                      var_cas_every = GGS_luint ::constructor_new (_inLexique, GGS_uint (1U), GGS_location (_inLexique) COMMA_HERE) ;
                      } break ;
                    case 2 : {
                  ...
                  if (_temp_3341.isBuilt ()) {
                    _temp_3341 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_masterTaskName, var_cas_masterTaskIndex, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, var_cas_taskProcessorIndex, var_cas_taskPeriod, automatic_var_6 COMMA_SOURCE_FILE_AT_LINE (119)) ;
                  }
                ...
                case 2 : {
                  ...
                  if (_temp_3689.isBuilt ()) {
                    _temp_3689 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_masterMessageName, var_cas_masterMessageIndex, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, var_cas_taskPeriod, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (126)) ;
                  }
                  _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_processor) COMMA_HERE) ;
                  GGS_lstring  var_cas_taskProcessorName ;
                  _inLexique._assignFromAttribute_identifierString (var_cas_taskProcessorName) ;
                  ...
                  if (_temp_4080.isBuilt ()) {
                    _temp_4080 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_taskProcessorName, var_cas_taskProcessorIndex, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (137)) ;
                  }
        ...
        case 5 : {
          ...
          switch (select_oa_parser_10 (_inLexique)) {
            case 1 : {
              ...
              var_cas_messageClass = GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_message) COMMA_HERE) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_extended) COMMA_HERE) ;
              var_cas_messageClass = GGS_luint ::constructor_new (_inLexique, GGS_uint (1U), GGS_location (_inLexique) COMMA_HERE) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_message) COMMA_HERE) ;
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_message) COMMA_HERE) ;
              var_cas_messageClass = GGS_luint ::constructor_new (_inLexique, GGS_uint (2U), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            default :
              break ;
          }
          ...
          if (_temp_5217.isBuilt ()) {
            _temp_5217 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_networkName, var_cas_networkIndex, var_cas_CANnetwork, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (171)) ;
          }
          if (((var_cas_CANnetwork)._operator_and ((var_cas_messageClass.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (172)))._operator_isEqual (GGS_uint (2U)))).isBuiltAndTrue ()) {
            var_cas_messageClass.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a CAN message must be either standard either extended") COMMA_SOURCE_FILE_AT_LINE (174)) ;
          }else if ((((var_cas_CANnetwork)._operator_not ())._operator_and ((var_cas_messageClass.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (174)))._operator_isNotEqual (GGS_uint (2U)))).isBuiltAndTrue ()) {
            var_cas_messageClass.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a VAN message cannot be standard or extended") COMMA_SOURCE_FILE_AT_LINE (176)) ;
          }
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5Finteger) COMMA_HERE) ;
          if (((var_cas_CANnetwork)._operator_and ((var_cas_bytesCount.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (180)))._operator_strictSup (GGS_uint (8U)))).isBuiltAndTrue ()) {
            var_cas_bytesCount.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("CAN message length must be <= 8 bytes") COMMA_SOURCE_FILE_AT_LINE (182)) ;
          }else if ((((var_cas_CANnetwork)._operator_not ())._operator_and ((var_cas_bytesCount.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (182)))._operator_strictSup (GGS_uint (28U)))).isBuiltAndTrue ()) {
            var_cas_bytesCount.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("VAN message must be <= 28 bytes") COMMA_SOURCE_FILE_AT_LINE (184)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_priority) COMMA_HERE) ;
          ...
          switch (select_oa_parser_12 (_inLexique)) {
            ...
            case 2 : {
              var_cas_deadline = GGS_luint ::constructor_new (_inLexique, GGS_uint (4294967295U), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            default :
              break ;
          }
          ...
          switch (select_oa_parser_13 (_inLexique)) {
            ...
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_on) COMMA_HERE) ;
              if ((var_cas_explicitOffset).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("A dependant task cannot have an offset") COMMA_SOURCE_FILE_AT_LINE (215)) ;
              }
              switch (select_oa_parser_14 (_inLexique)) {
                case 1 : {
                  ...
                  if (_temp_6806.isBuilt ()) {
                    _temp_6806 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_name, var_cas_messageIndex, automatic_var_16, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20, automatic_var_21, var_cas_period, automatic_var_22 COMMA_SOURCE_FILE_AT_LINE (221)) ;
                  }
                ...
                case 2 : {
                  ...
                  if (_temp_7081.isBuilt ()) {
                    _temp_7081 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_taskName, var_cas_taskIndex, automatic_var_23, automatic_var_24, automatic_var_25, automatic_var_26, automatic_var_27, automatic_var_28, var_cas_period, automatic_var_29 COMMA_SOURCE_FILE_AT_LINE (228)) ;
                  }
  ...
  if (var_cas_outProcessorMap.isBuilt () &&
    ...
    ::routine_performComputations (_inLexique,  var_cas_outProcessorMap,  var_cas_outNetworkMap,  var_cas_outMessagesMap,  var_cas_outTaskMap COMMA_SOURCE_FILE_AT_LINE (237)) ;
  }
}
