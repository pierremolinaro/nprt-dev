      ...
      switch (select_repeat_oa_parser_0 (_inLexique)) {
          ...
          switch (select_oa_parser_6 (_inLexique)) {
            case 1 : {
              ...
              if (var_cas_outProcessorMap._isBuilt ()) {
                var_cas_outProcessorMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_taskProcessorName, var_cas_taskProcessorIndex, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (100)) ;
              }
              ...
              switch (select_oa_parser_7 (_inLexique)) {
                case 1 : {
                  ...
                  if (var_cas_outTaskMap._isBuilt ()) {
                    var_cas_outTaskMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_masterTaskName, var_cas_masterTaskIndex, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, var_cas_taskProcessorIndex, var_cas_taskPeriod, automatic_var_6 COMMA_SOURCE_FILE_AT_LINE (119)) ;
                  }
                ...
                case 2 : {
                  ...
                  if (var_cas_outMessagesMap._isBuilt ()) {
                    var_cas_outMessagesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_masterMessageName, var_cas_masterMessageIndex, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, var_cas_taskPeriod, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (126)) ;
                  }
                  _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_processor) COMMA_HERE) ;
                  GGS_lstring  var_cas_taskProcessorName ;
                  _inLexique._assignFromAttribute_identifierString (var_cas_taskProcessorName) ;
                  ...
                  if (var_cas_outProcessorMap._isBuilt ()) {
                    var_cas_outProcessorMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_taskProcessorName, var_cas_taskProcessorIndex, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (137)) ;
                  }
        ...
        case 5 : {
          ...
          if (var_cas_outNetworkMap._isBuilt ()) {
            var_cas_outNetworkMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_networkName, var_cas_networkIndex, var_cas_CANnetwork, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (171)) ;
          }
            ...
            case 2 : {
              ...
              switch (select_oa_parser_14 (_inLexique)) {
                case 1 : {
                  ...
                  if (var_cas_outMessagesMap._isBuilt ()) {
                    var_cas_outMessagesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_name, var_cas_messageIndex, automatic_var_16, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20, automatic_var_21, var_cas_period, automatic_var_22 COMMA_SOURCE_FILE_AT_LINE (221)) ;
                  }
                ...
                case 2 : {
                  ...
                  if (var_cas_outTaskMap._isBuilt ()) {
                    var_cas_outTaskMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_taskName, var_cas_taskIndex, automatic_var_23, automatic_var_24, automatic_var_25, automatic_var_26, automatic_var_27, automatic_var_28, var_cas_period, automatic_var_29 COMMA_SOURCE_FILE_AT_LINE (228)) ;
                  }
