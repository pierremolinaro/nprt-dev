    ...
    while (syntaxRepeat) {
      switch (select_repeat_oa_parser_0 (lexique_var_)) {
        ...
        case 4 : {
          ...
          switch (select_oa_parser_6 (lexique_var_)) {
            case 1 : {
              ...
              GGS_luint  var_cas_7780 ;
              if (var_cas_outProcessorMap.isBuilt ()) {
                var_cas_outProcessorMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_taskProcessorName, var_cas_taskProcessorIndex, var_cas_7780) ;
              }
            ...
            case 2 : {
              ...
              switch (select_oa_parser_7 (lexique_var_)) {
                case 1 : {
                  ...
                  GGS_luint  var_cas_8340 ;
                  GGS_luint  var_cas_8343 ;
                  GGS_luint  var_cas_8346 ;
                  GGS_luint  var_cas_8349 ;
                  GGS_luint  var_cas_8352 ;
                  GGS_AC_task  var_cas_8387 ;
                  if (var_cas_outTaskMap.isBuilt ()) {
                    var_cas_outTaskMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_masterTaskName, var_cas_masterTaskIndex, var_cas_8340, var_cas_8343, var_cas_8346, var_cas_8349, var_cas_8352, var_cas_taskProcessorIndex, var_cas_taskPeriod, var_cas_8387) ;
                  }
                ...
                case 2 : {
                  ...
                  GGS_luint  var_cas_8696 ;
                  GGS_luint  var_cas_8699 ;
                  GGS_luint  var_cas_8702 ;
                  GGS_luint  var_cas_8705 ;
                  GGS_luint  var_cas_8708 ;
                  GGS_luint  var_cas_8711 ;
                  GGS_AC_canMessage  var_cas_8726 ;
                  if (var_cas_outMessagesMap.isBuilt ()) {
                    var_cas_outMessagesMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_masterMessageName, var_cas_masterMessageIndex, var_cas_8696, var_cas_8699, var_cas_8702, var_cas_8705, var_cas_8708, var_cas_8711, var_cas_taskPeriod, var_cas_8726) ;
                  }
                  lexique_var_.acceptTerminal (oa_scanner::oa_scanner_1_processor) ;
                  GGS_lstring  var_cas_taskProcessorName ;
                  lexique_var_.acceptTerminal (oa_scanner::oa_scanner_1_identifier) ;
                  ...
                  GGS_luint  var_cas_9089 ;
                  if (var_cas_outProcessorMap.isBuilt ()) {
                    var_cas_outProcessorMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_taskProcessorName, var_cas_taskProcessorIndex, var_cas_9089) ;
                  }
        ...
        case 5 : {
          ...
          GGS_luint  var_cas_10228 ;
          if (var_cas_outNetworkMap.isBuilt ()) {
            var_cas_outNetworkMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_networkName, var_cas_networkIndex, var_cas_CANnetwork, var_cas_10228) ;
          }
            ...
            case 2 : {
              ...
              switch (select_oa_parser_14 (lexique_var_)) {
                case 1 : {
                  ...
                  GGS_luint  var_cas_11804 ;
                  GGS_luint  var_cas_11807 ;
                  GGS_luint  var_cas_11810 ;
                  GGS_luint  var_cas_11813 ;
                  GGS_luint  var_cas_11816 ;
                  GGS_luint  var_cas_11819 ;
                  GGS_AC_canMessage  var_cas_11830 ;
                  if (var_cas_outMessagesMap.isBuilt ()) {
                    var_cas_outMessagesMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_name, var_cas_messageIndex, var_cas_11804, var_cas_11807, var_cas_11810, var_cas_11813, var_cas_11816, var_cas_11819, var_cas_period, var_cas_11830) ;
                  }
                ...
                case 2 : {
                  ...
                  GGS_luint  var_cas_12082 ;
                  GGS_luint  var_cas_12085 ;
                  GGS_luint  var_cas_12088 ;
                  GGS_luint  var_cas_12091 ;
                  GGS_luint  var_cas_12094 ;
                  GGS_luint  var_cas_12097 ;
                  GGS_AC_task  var_cas_12108 ;
                  if (var_cas_outTaskMap.isBuilt ()) {
                    var_cas_outTaskMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_taskName, var_cas_taskIndex, var_cas_12082, var_cas_12085, var_cas_12088, var_cas_12091, var_cas_12094, var_cas_12097, var_cas_period, var_cas_12108) ;
                  }
