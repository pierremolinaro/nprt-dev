...
//                    november 14th, 2006, at 19h54'18"                      *
//                                                                           *
//---------------------------------------------------------------------------*
    ...
    while (syntaxRepeat) {
      switch (select_repeat_oa_parser_0 (_inLexique)) {
        ...
        case 4 : {
          ...
          switch (select_oa_parser_6 (_inLexique)) {
            case 1 : {
              ...
              GGS_luint  var_cas_2813 ;
              if (var_cas_outProcessorMap._isBuilt ()) {
                var_cas_outProcessorMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_taskProcessorName, var_cas_taskProcessorIndex, var_cas_2813 SOURCE_FILE_AT_LINE (100)) ;
              }
            ...
            case 2 : {
              ...
              switch (select_oa_parser_7 (_inLexique)) {
                case 1 : {
                  ...
                  GGS_luint  var_cas_3371 ;
                  GGS_luint  var_cas_3374 ;
                  GGS_luint  var_cas_3377 ;
                  GGS_luint  var_cas_3380 ;
                  GGS_luint  var_cas_3383 ;
                  GGS_AC_task  var_cas_3418 ;
                  if (var_cas_outTaskMap._isBuilt ()) {
                    var_cas_outTaskMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_masterTaskName, var_cas_masterTaskIndex, var_cas_3371, var_cas_3374, var_cas_3377, var_cas_3380, var_cas_3383, var_cas_taskProcessorIndex, var_cas_taskPeriod, var_cas_3418 SOURCE_FILE_AT_LINE (119)) ;
                  }
                ...
                case 2 : {
                  ...
                  GGS_luint  var_cas_3725 ;
                  GGS_luint  var_cas_3728 ;
                  GGS_luint  var_cas_3731 ;
                  GGS_luint  var_cas_3734 ;
                  GGS_luint  var_cas_3737 ;
                  GGS_luint  var_cas_3740 ;
                  GGS_AC_canMessage  var_cas_3755 ;
                  if (var_cas_outMessagesMap._isBuilt ()) {
                    var_cas_outMessagesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_masterMessageName, var_cas_masterMessageIndex, var_cas_3725, var_cas_3728, var_cas_3731, var_cas_3734, var_cas_3737, var_cas_3740, var_cas_taskPeriod, var_cas_3755 SOURCE_FILE_AT_LINE (126)) ;
                  }
                  _inLexique.acceptTerminal (oa_scanner::oa_scanner_1_processor) ;
                  GGS_lstring  var_cas_taskProcessorName ;
                  _inLexique.acceptTerminal (oa_scanner::oa_scanner_1_identifier) ;
                  ...
                  GGS_luint  var_cas_4116 ;
                  if (var_cas_outProcessorMap._isBuilt ()) {
                    var_cas_outProcessorMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_taskProcessorName, var_cas_taskProcessorIndex, var_cas_4116 SOURCE_FILE_AT_LINE (137)) ;
                  }
        ...
        case 5 : {
          ...
          GGS_luint  var_cas_5253 ;
          if (var_cas_outNetworkMap._isBuilt ()) {
            var_cas_outNetworkMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_networkName, var_cas_networkIndex, var_cas_CANnetwork, var_cas_5253 SOURCE_FILE_AT_LINE (171)) ;
          }
            ...
            case 2 : {
              ...
              switch (select_oa_parser_14 (_inLexique)) {
                case 1 : {
                  ...
                  GGS_luint  var_cas_6823 ;
                  GGS_luint  var_cas_6826 ;
                  GGS_luint  var_cas_6829 ;
                  GGS_luint  var_cas_6832 ;
                  GGS_luint  var_cas_6835 ;
                  GGS_luint  var_cas_6838 ;
                  GGS_AC_canMessage  var_cas_6849 ;
                  if (var_cas_outMessagesMap._isBuilt ()) {
                    var_cas_outMessagesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_name, var_cas_messageIndex, var_cas_6823, var_cas_6826, var_cas_6829, var_cas_6832, var_cas_6835, var_cas_6838, var_cas_period, var_cas_6849 SOURCE_FILE_AT_LINE (221)) ;
                  }
                ...
                case 2 : {
                  ...
                  GGS_luint  var_cas_7099 ;
                  GGS_luint  var_cas_7102 ;
                  GGS_luint  var_cas_7105 ;
                  GGS_luint  var_cas_7108 ;
                  GGS_luint  var_cas_7111 ;
                  GGS_luint  var_cas_7114 ;
                  GGS_AC_task  var_cas_7125 ;
                  if (var_cas_outTaskMap._isBuilt ()) {
                    var_cas_outTaskMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_taskName, var_cas_taskIndex, var_cas_7099, var_cas_7102, var_cas_7105, var_cas_7108, var_cas_7111, var_cas_7114, var_cas_period, var_cas_7125 SOURCE_FILE_AT_LINE (228)) ;
                  }
