...
void oa_parser::
oa_parser::
pr_axiome_oa_parser_13_6_ (oa_scanner & _inLexique) {
    ...
    while (syntaxRepeat) {
      switch (select_repeat_oa_parser_0 (_inLexique)) {
        case 2 : {
          ...
          var_cas_outProcessorMap.modifier_insertKey (_inLexique, var_cas_processorName, var_cas_step SOURCE_FILE_AT_LINE (35)) ;
        ...
        case 3 : {
          ...
          var_cas_outNetworkMap.modifier_insertKey (_inLexique, var_cas_networkName, var_cas_network, var_cas_factor SOURCE_FILE_AT_LINE (59)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1__3B) COMMA_HERE) ;
          } break ;
        case 4 : {
          ...
          var_cas_outTaskMap.modifier_insertKey (_inLexique, var_cas_taskName, var_cas_taskPriority, var_cas_taskOffset, var_cas_taskDeadline, var_cas_taskDurationMin, var_cas_taskDurationMax, var_cas_taskProcessorIndex, var_cas_taskPeriod, var_cas_taskKind SOURCE_FILE_AT_LINE (141)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1__3B) COMMA_HERE) ;
          } break ;
        case 5 : {
          ...
          var_cas_outMessagesMap.modifier_insertKey (_inLexique, var_cas_messageName, var_cas_messageClass, var_cas_networkIndex, var_cas_bytesCount, var_cas_priority, var_cas_offset, var_cas_deadline, var_cas_period, var_cas_messageKind SOURCE_FILE_AT_LINE (232)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1__3B) COMMA_HERE) ;
          } break ;
        default :
          syntaxRepeat = false ;
  ...
  if (var_cas_outProcessorMap._isBuilt () &&
    ...
    ::routine_performComputations (_inLexique,  var_cas_outProcessorMap,  var_cas_outNetworkMap,  var_cas_outMessagesMap,  var_cas_outTaskMap SOURCE_FILE_AT_LINE (237)) ;
  }
}
