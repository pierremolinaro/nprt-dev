    ...
    while (syntaxRepeat_0) {
      switch (select_oa_parser_0 (inLexique)) {
        ...
        case 3 : {
          ...
          switch (select_oa_parser_3 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5F_integer) COMMA_HERE) ;
              const GGS_bool cond_1703 = (var_cas_factor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (56))).operator_isEqual (GGS_uint (0U)) ;
              if (cond_1703.isBuiltAndTrue ()) {
        ...
        case 4 : {
          ...
          switch (select_oa_parser_6 (inLexique)) {
            case 1 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_identifier) COMMA_HERE) ;
              GGS_luint  automatic_var_2893_0 ;
              const GGS_M_processor  temp_2850 = var_cas_outProcessorMap ;
              if (temp_2850.isBuilt ()) {
                temp_2850 (HERE)->method_searchKey (inLexique, var_cas_taskProcessorName, var_cas_taskProcessorIndex, automatic_var_2893_0 COMMA_SOURCE_FILE_AT_LINE (101)) ;
              }
            ...
            case 2 : {
              ...
              const GGS_bool cond_3063 = var_cas_explicitOffset ;
              ...
              switch (select_oa_parser_7 (inLexique)) {
                case 1 : {
                  ...
                  GGS_luint  automatic_var_3489_0 ;
                  GGS_luint  automatic_var_3489_1 ;
                  GGS_luint  automatic_var_3489_2 ;
                  GGS_luint  automatic_var_3489_3 ;
                  GGS_luint  automatic_var_3489_4 ;
                  GGS_AC_task  automatic_var_3489_5 ;
                  const GGS_M_tasks  temp_3405 = var_cas_outTaskMap ;
                  if (temp_3405.isBuilt ()) {
                    temp_3405 (HERE)->method_searchKey (inLexique, var_cas_masterTaskName, var_cas_masterTaskIndex, automatic_var_3489_0, automatic_var_3489_1, automatic_var_3489_2, automatic_var_3489_3, automatic_var_3489_4, var_cas_taskProcessorIndex, var_cas_taskPeriod, automatic_var_3489_5 COMMA_SOURCE_FILE_AT_LINE (120)) ;
                  }
                ...
                case 2 : {
                  ...
                  GGS_luint  automatic_var_3817_0 ;
                  GGS_uint  automatic_var_3817_1 ;
                  GGS_luint  automatic_var_3817_2 ;
                  GGS_luint  automatic_var_3817_3 ;
                  GGS_luint  automatic_var_3817_4 ;
                  GGS_luint  automatic_var_3817_5 ;
                  GGS_AC_canMessage  automatic_var_3817_6 ;
                  const GGS_M_messages  temp_3744 = var_cas_outMessagesMap ;
                  if (temp_3744.isBuilt ()) {
                    temp_3744 (HERE)->method_searchKey (inLexique, var_cas_masterMessageName, var_cas_masterMessageIndex, automatic_var_3817_0, automatic_var_3817_1, automatic_var_3817_2, automatic_var_3817_3, automatic_var_3817_4, automatic_var_3817_5, var_cas_taskPeriod, automatic_var_3817_6 COMMA_SOURCE_FILE_AT_LINE (127)) ;
                  }
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_processor) COMMA_HERE) ;
                  GGS_lstring  var_cas_taskProcessorName ;
                  inLexique.assignFromAttribute_identifierString (var_cas_taskProcessorName) ;
                  ...
                  GGS_luint  automatic_var_4170_0 ;
                  const GGS_M_processor  temp_4127 = var_cas_outProcessorMap ;
                  if (temp_4127.isBuilt ()) {
                    temp_4127 (HERE)->method_searchKey (inLexique, var_cas_taskProcessorName, var_cas_taskProcessorIndex, automatic_var_4170_0 COMMA_SOURCE_FILE_AT_LINE (138)) ;
                  }
        ...
        case 5 : {
          ...
          GGS_luint  automatic_var_5356_0 ;
          const GGS_M_network  temp_5313 = var_cas_outNetworkMap ;
          if (temp_5313.isBuilt ()) {
            temp_5313 (HERE)->method_searchKey (inLexique, var_cas_networkName, var_cas_networkIndex, var_cas_CANnetwork, automatic_var_5356_0 COMMA_SOURCE_FILE_AT_LINE (173)) ;
          }
          const GGS_bool cond_5505 = (var_cas_CANnetwork).operator_and ((var_cas_messageClass.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (174))).operator_isEqual (GGS_uint (2U))) ;
          ...
          }else if (cond_5505.isBuiltAndFalse ()) {
            const GGS_bool cond_5640 = ((var_cas_CANnetwork).operator_not ()).operator_and ((var_cas_messageClass.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (176))).operator_isNotEqual (GGS_uint (2U))) ;
            if (cond_5640.isBuiltAndTrue ()) {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_literal_5F_integer) COMMA_HERE) ;
          const GGS_bool cond_5847 = (var_cas_CANnetwork).operator_and ((var_cas_bytesCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (182))).operator_strictSup (GGS_uint (8U))) ;
          ...
          }else if (cond_5847.isBuiltAndFalse ()) {
            const GGS_bool cond_5965 = ((var_cas_CANnetwork).operator_not ()).operator_and ((var_cas_bytesCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (184))).operator_strictSup (GGS_uint (28U))) ;
            if (cond_5965.isBuiltAndTrue ()) {
          ...
          switch (select_oa_parser_13 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_on) COMMA_HERE) ;
              const GGS_bool cond_6738 = var_cas_explicitOffset ;
              if (cond_6738.isBuiltAndTrue ()) {
              ...
              switch (select_oa_parser_14 (inLexique)) {
                case 1 : {
                  ...
                  GGS_luint  automatic_var_6943_0 ;
                  GGS_uint  automatic_var_6943_1 ;
                  GGS_luint  automatic_var_6943_2 ;
                  GGS_luint  automatic_var_6943_3 ;
                  GGS_luint  automatic_var_6943_4 ;
                  GGS_luint  automatic_var_6943_5 ;
                  GGS_AC_canMessage  automatic_var_6943_6 ;
                  const GGS_M_messages  temp_6893 = var_cas_outMessagesMap ;
                  if (temp_6893.isBuilt ()) {
                    temp_6893 (HERE)->method_searchKey (inLexique, var_cas_name, var_cas_messageIndex, automatic_var_6943_0, automatic_var_6943_1, automatic_var_6943_2, automatic_var_6943_3, automatic_var_6943_4, automatic_var_6943_5, var_cas_period, automatic_var_6943_6 COMMA_SOURCE_FILE_AT_LINE (223)) ;
                  }
                ...
                case 2 : {
                  ...
                  GGS_luint  automatic_var_7210_0 ;
                  GGS_luint  automatic_var_7210_1 ;
                  GGS_luint  automatic_var_7210_2 ;
                  GGS_luint  automatic_var_7210_3 ;
                  GGS_luint  automatic_var_7210_4 ;
                  GGS_uint  automatic_var_7210_5 ;
                  GGS_AC_task  automatic_var_7210_6 ;
                  const GGS_M_tasks  temp_7159 = var_cas_outTaskMap ;
                  if (temp_7159.isBuilt ()) {
                    temp_7159 (HERE)->method_searchKey (inLexique, var_cas_taskName, var_cas_taskIndex, automatic_var_7210_0, automatic_var_7210_1, automatic_var_7210_2, automatic_var_7210_3, automatic_var_7210_4, automatic_var_7210_5, var_cas_period, automatic_var_7210_6 COMMA_SOURCE_FILE_AT_LINE (230)) ;
                  }
