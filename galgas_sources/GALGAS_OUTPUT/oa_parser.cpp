      ...
      switch (select_repeat_oa_parser_0 (_inLexique)) {
          ...
          switch (select_oa_parser_1 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (((var_cas_step.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (31)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                var_cas_step.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the step value must be > 0") COMMA_SOURCE_FILE_AT_LINE (33)) ;
              }
              } break ;
            default :
              break ;
          ...
          switch (select_oa_parser_3 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (((var_cas_factor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (55)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                var_cas_factor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the factor value must be > 0") COMMA_SOURCE_FILE_AT_LINE (57)) ;
              }
              } break ;
            default :
              break ;
          ...
          switch (select_oa_parser_6 (_inLexique)) {
            ...
            case 2 : {
              ...
              if ((var_cas_explicitOffset).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "A dependant task cannot have an offset") COMMA_SOURCE_FILE_AT_LINE (106)) ;
              }
        ...
        case 5 : {
          ...
          if (((var_cas_CANnetwork)._operator_and ((var_cas_messageClass.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (172)))._operator_isEqual (GGS_uint (true, 2U)))).isBuiltAndTrue ()) {
            var_cas_messageClass.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a CAN message must be either standard either extended") COMMA_SOURCE_FILE_AT_LINE (174)) ;
            ...
            var_cas_messageClass.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a VAN message cannot be standard or extended") COMMA_SOURCE_FILE_AT_LINE (176)) ;
          }
          ...
          if (((var_cas_CANnetwork)._operator_and ((var_cas_bytesCount.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (180)))._operator_strictSup (GGS_uint (true, 8U)))).isBuiltAndTrue ()) {
            var_cas_bytesCount.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "CAN message length must be <= 8 bytes") COMMA_SOURCE_FILE_AT_LINE (182)) ;
            ...
            var_cas_bytesCount.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "VAN message must be <= 28 bytes") COMMA_SOURCE_FILE_AT_LINE (184)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_priority) COMMA_HERE) ;
          ...
          switch (select_oa_parser_13 (_inLexique)) {
            ...
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (oa_scanner::oa_scanner_1_on) COMMA_HERE) ;
              if ((var_cas_explicitOffset).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "A dependant task cannot have an offset") COMMA_SOURCE_FILE_AT_LINE (215)) ;
              }
