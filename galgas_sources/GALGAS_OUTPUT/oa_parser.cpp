...
void oa_parser::
pr_axiome_oa_parser_14_13_ (C_Lexique_oa_5F_scanner & inLexique) {
    ...
    while (syntaxRepeat_0) {
      switch (select_oa_5F_parser_0 (inLexique)) {
        ...
        case 4 : {
          ...
          switch (select_oa_5F_parser_6 (inLexique)) {
            case 1 : {
              ...
              const GGS_M_processor  temp_2857 = var_cas_outProcessorMap ;
              if (temp_2857.isBuilt ()) {
                temp_2857 (HERE)->method_searchKey (inLexique, var_cas_taskProcessorName, var_cas_taskProcessorIndex, automatic_var_2900_0 COMMA_SOURCE_FILE_AT_LINE (101)) ;
              }
            ...
            case 2 : {
              ...
              switch (select_oa_5F_parser_7 (inLexique)) {
                case 1 : {
                  ...
                  const GGS_M_tasks  temp_3412 = var_cas_outTaskMap ;
                  if (temp_3412.isBuilt ()) {
                    temp_3412 (HERE)->method_searchKey (inLexique, var_cas_masterTaskName, var_cas_masterTaskIndex, automatic_var_3496_0, automatic_var_3496_1, automatic_var_3496_2, automatic_var_3496_3, automatic_var_3496_4, var_cas_taskProcessorIndex, var_cas_taskPeriod, automatic_var_3496_5 COMMA_SOURCE_FILE_AT_LINE (120)) ;
                  }
                ...
                case 2 : {
                  ...
                  const GGS_M_messages  temp_3751 = var_cas_outMessagesMap ;
                  if (temp_3751.isBuilt ()) {
                    temp_3751 (HERE)->method_searchKey (inLexique, var_cas_masterMessageName, var_cas_masterMessageIndex, automatic_var_3824_0, automatic_var_3824_1, automatic_var_3824_2, automatic_var_3824_3, automatic_var_3824_4, automatic_var_3824_5, var_cas_taskPeriod, automatic_var_3824_6 COMMA_SOURCE_FILE_AT_LINE (127)) ;
                  }
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_oa_5F_scanner::kToken_processor) COMMA_HERE) ;
                  GGS_lstring  var_cas_taskProcessorName ;
                  inLexique.assignFromAttribute_identifierString (var_cas_taskProcessorName) ;
                  ...
                  const GGS_M_processor  temp_4134 = var_cas_outProcessorMap ;
                  if (temp_4134.isBuilt ()) {
                    temp_4134 (HERE)->method_searchKey (inLexique, var_cas_taskProcessorName, var_cas_taskProcessorIndex, automatic_var_4177_0 COMMA_SOURCE_FILE_AT_LINE (138)) ;
                  }
        ...
        case 5 : {
          ...
          const GGS_M_network  temp_5320 = var_cas_outNetworkMap ;
          if (temp_5320.isBuilt ()) {
            temp_5320 (HERE)->method_searchKey (inLexique, var_cas_networkName, var_cas_networkIndex, var_cas_CANnetwork, automatic_var_5363_0 COMMA_SOURCE_FILE_AT_LINE (173)) ;
          }
            ...
            case 2 : {
              ...
              switch (select_oa_5F_parser_14 (inLexique)) {
                case 1 : {
                  ...
                  const GGS_M_messages  temp_6900 = var_cas_outMessagesMap ;
                  if (temp_6900.isBuilt ()) {
                    temp_6900 (HERE)->method_searchKey (inLexique, var_cas_name, var_cas_messageIndex, automatic_var_6950_0, automatic_var_6950_1, automatic_var_6950_2, automatic_var_6950_3, automatic_var_6950_4, automatic_var_6950_5, var_cas_period, automatic_var_6950_6 COMMA_SOURCE_FILE_AT_LINE (223)) ;
                  }
                ...
                case 2 : {
                  ...
                  const GGS_M_tasks  temp_7166 = var_cas_outTaskMap ;
                  if (temp_7166.isBuilt ()) {
                    temp_7166 (HERE)->method_searchKey (inLexique, var_cas_taskName, var_cas_taskIndex, automatic_var_7217_0, automatic_var_7217_1, automatic_var_7217_2, automatic_var_7217_3, automatic_var_7217_4, automatic_var_7217_5, var_cas_period, automatic_var_7217_6 COMMA_SOURCE_FILE_AT_LINE (230)) ;
                  }
