    ...
    while (syntaxRepeat) {
      switch (select_repeat_oa_parser_0 (_inLexique)) {
        case 2 : {
          ...
          switch (select_oa_parser_1 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (((var_cas_step.reader_value (_inLexique SOURCE_FILE_AT_LINE (189))) == (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        ...
        case 3 : {
          ...
          switch (select_oa_parser_3 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (((var_cas_factor.reader_value (_inLexique SOURCE_FILE_AT_LINE (213))) == (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        ...
        case 5 : {
          ...
          if ((((var_cas_CANnetwork) & ((var_cas_messageClass.reader_value (_inLexique SOURCE_FILE_AT_LINE (330))) == (GGS_uint (true, 2U))))).isBuiltAndTrue ()) {
          ...
          }else if (((((! (var_cas_CANnetwork))) & ((var_cas_messageClass.reader_value (_inLexique SOURCE_FILE_AT_LINE (332))) != (GGS_uint (true, 2U))))).isBuiltAndTrue ()) {
          ...
          if ((((var_cas_CANnetwork) & ((var_cas_bytesCount.reader_value (_inLexique SOURCE_FILE_AT_LINE (338))) > (GGS_uint (true, 8U))))).isBuiltAndTrue ()) {
          ...
          }else if (((((! (var_cas_CANnetwork))) & ((var_cas_bytesCount.reader_value (_inLexique SOURCE_FILE_AT_LINE (340))) > (GGS_uint (true, 28U))))).isBuiltAndTrue ()) {
