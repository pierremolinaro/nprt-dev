...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  return (mInfo.mStep._operator_isEqual (ptr->mInfo.mStep)).boolValue () ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mCANnetwork._operator_isEqual (ptr->mInfo.mCANnetwork)).boolValue ()
           && (mInfo.mScalingFactor._operator_isEqual (ptr->mInfo.mScalingFactor)).boolValue () ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mMessageIndex._operator_isEqual (ptr->mMessageIndex).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mTaskIndex._operator_isEqual (ptr->mTaskIndex).boolValue () ;
  }
  return equal ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mClass._operator_isEqual (ptr->mInfo.mClass)).boolValue ()
           && (mInfo.mNetworkIndex._operator_isEqual (ptr->mInfo.mNetworkIndex)).boolValue ()
           && (mInfo.mBytesCount._operator_isEqual (ptr->mInfo.mBytesCount)).boolValue ()
           && (mInfo.mPriority._operator_isEqual (ptr->mInfo.mPriority)).boolValue ()
           && (mInfo.mOffset._operator_isEqual (ptr->mInfo.mOffset)).boolValue ()
           && (mInfo.mDeadline._operator_isEqual (ptr->mInfo.mDeadline)).boolValue ()
           && (mInfo.mPeriod._operator_isEqual (ptr->mInfo.mPeriod)).boolValue ()
           && (mInfo.mMessageKind._operator_isEqual (ptr->mInfo.mMessageKind)).boolValue () ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mTask._operator_isEqual (ptr->mTask).boolValue ()
         && mEvery._operator_isEqual (ptr->mEvery).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mMessage._operator_isEqual (ptr->mMessage).boolValue ()
         && mEvery._operator_isEqual (ptr->mEvery).boolValue () ;
  }
  return equal ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mPriority._operator_isEqual (ptr->mInfo.mPriority)).boolValue ()
           && (mInfo.mOffset._operator_isEqual (ptr->mInfo.mOffset)).boolValue ()
           && (mInfo.mDeadline._operator_isEqual (ptr->mInfo.mDeadline)).boolValue ()
           && (mInfo.mDurationMin._operator_isEqual (ptr->mInfo.mDurationMin)).boolValue ()
           && (mInfo.mDurationMax._operator_isEqual (ptr->mInfo.mDurationMax)).boolValue ()
           && (mInfo.mProcessor._operator_isEqual (ptr->mInfo.mProcessor)).boolValue ()
           && (mInfo.mPeriod._operator_isEqual (ptr->mInfo.mPeriod)).boolValue ()
           && (mInfo.mTaskKind._operator_isEqual (ptr->mInfo.mTaskKind)).boolValue () ;
}
