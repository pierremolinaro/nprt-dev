...
void cMapElement_M_5F_processor::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
...
GALGAS_M_5F_processor GALGAS_M_5F_processor::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_M_5F_processor result ;
...
void GALGAS_M_5F_processor::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    macroValidSharedObject (p, const cMapElement_M_5F_processor) ;
...
cMapElement_M_5F_processor * GALGAS_M_5F_processor::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
                                                                                              const GALGAS_string & inKey
                                                                                              COMMA_LOCATION_ARGS) {
  cMapElement * p = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
  cMapElement_M_5F_processor * result = (cMapElement_M_5F_processor *) p ;
...
cMapElement_M_5F_processor * GALGAS_M_5F_processor::readWriteAccessForWithInstruction_searchKey (C_Compiler * inCompiler,
                                                                                                 const GALGAS_lstring & inKey
                                                                                                 COMMA_LOCATION_ARGS) {
  cMapElement * p = searchForReadWriteAttribute (inKey, inCompiler, kSearchErrorMessage_M_5F_processor_searchKey COMMA_THERE) ;
  cMapElement_M_5F_processor * result = (cMapElement_M_5F_processor *) p ;
  macroNullOrValidSharedObject (result, cMapElement_M_5F_processor) ;
  return result ;
}
...
GALGAS_M_5F_processor_3A_element cEnumerator_M_5F_processor::current (LOCATION_ARGS) const {
  const cMapElement_M_5F_processor * p = (const cMapElement_M_5F_processor *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_M_5F_processor) ;
  return GALGAS_M_5F_processor_3A_element (p->mAttribute_lkey, p->mAttribute_mIndex, p->mAttribute_mStep) ;
}
...
GALGAS_M_5F_processor GALGAS_M_5F_processor::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_M_5F_processor *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "M_processor", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void cMapElement_M_5F_network::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mIndex" ":" ;
  mAttribute_mIndex.description (ioString, inIndentation) ;
...
GALGAS_M_5F_network GALGAS_M_5F_network::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_M_5F_network result ;
  getOverridenMap (result) ;
  return result ;
}
...
void GALGAS_M_5F_network::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    macroValidSharedObject (p, const cMapElement_M_5F_network) ;
    outArgument0 = p->mAttribute_mIndex ;
...
cMapElement_M_5F_network * GALGAS_M_5F_network::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
                                                                                          const GALGAS_string & inKey
                                                                                          COMMA_LOCATION_ARGS) {
  cMapElement * p = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
  cMapElement_M_5F_network * result = (cMapElement_M_5F_network *) p ;
...
cMapElement_M_5F_network * GALGAS_M_5F_network::readWriteAccessForWithInstruction_searchKey (C_Compiler * inCompiler,
                                                                                             const GALGAS_lstring & inKey
                                                                                             COMMA_LOCATION_ARGS) {
  cMapElement * p = searchForReadWriteAttribute (inKey, inCompiler, kSearchErrorMessage_M_5F_network_searchKey COMMA_THERE) ;
  cMapElement_M_5F_network * result = (cMapElement_M_5F_network *) p ;
  macroNullOrValidSharedObject (result, cMapElement_M_5F_network) ;
  return result ;
}
...
GALGAS_M_5F_network_3A_element cEnumerator_M_5F_network::current (LOCATION_ARGS) const {
  const cMapElement_M_5F_network * p = (const cMapElement_M_5F_network *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_M_5F_network) ;
  return GALGAS_M_5F_network_3A_element (p->mAttribute_lkey, p->mAttribute_mIndex, p->mAttribute_mCANnetwork, p->mAttribute_mScalingFactor) ;
}
...
GALGAS_M_5F_network GALGAS_M_5F_network::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_M_5F_network *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "M_network", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void cMapElement_M_5F_messages::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mIndex" ":" ;
  mAttribute_mIndex.description (ioString, inIndentation) ;
...
GALGAS_M_5F_messages GALGAS_M_5F_messages::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_M_5F_messages result ;
  getOverridenMap (result) ;
  return result ;
}
...
void GALGAS_M_5F_messages::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    macroValidSharedObject (p, const cMapElement_M_5F_messages) ;
    outArgument0 = p->mAttribute_mIndex ;
...
cMapElement_M_5F_messages * GALGAS_M_5F_messages::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
                                                                                            const GALGAS_string & inKey
                                                                                            COMMA_LOCATION_ARGS) {
  cMapElement * p = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
  cMapElement_M_5F_messages * result = (cMapElement_M_5F_messages *) p ;
...
cMapElement_M_5F_messages * GALGAS_M_5F_messages::readWriteAccessForWithInstruction_searchKey (C_Compiler * inCompiler,
                                                                                               const GALGAS_lstring & inKey
                                                                                               COMMA_LOCATION_ARGS) {
  cMapElement * p = searchForReadWriteAttribute (inKey, inCompiler, kSearchErrorMessage_M_5F_messages_searchKey COMMA_THERE) ;
  cMapElement_M_5F_messages * result = (cMapElement_M_5F_messages *) p ;
  macroNullOrValidSharedObject (result, cMapElement_M_5F_messages) ;
  return result ;
}
...
GALGAS_M_5F_messages_3A_element cEnumerator_M_5F_messages::current (LOCATION_ARGS) const {
  const cMapElement_M_5F_messages * p = (const cMapElement_M_5F_messages *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_M_5F_messages) ;
  return GALGAS_M_5F_messages_3A_element (p->mAttribute_lkey, p->mAttribute_mIndex, p->mAttribute_mClass, p->mAttribute_mNetworkIndex, p->mAttribute_mBytesCount, p->mAttribute_mPriority, p->mAttribute_mOffset, p->mAttribute_mDeadline, p->mAttribute_mPeriod, p->mAttribute_mMessageKind) ;
}
...
GALGAS_M_5F_messages GALGAS_M_5F_messages::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_M_5F_messages *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "M_messages", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void cMapElement_M_5F_tasks::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mIndex" ":" ;
  mAttribute_mIndex.description (ioString, inIndentation) ;
...
GALGAS_M_5F_tasks GALGAS_M_5F_tasks::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_M_5F_tasks result ;
  getOverridenMap (result) ;
  return result ;
}
...
void GALGAS_M_5F_tasks::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    macroValidSharedObject (p, const cMapElement_M_5F_tasks) ;
    outArgument0 = p->mAttribute_mIndex ;
...
cMapElement_M_5F_tasks * GALGAS_M_5F_tasks::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
                                                                                      const GALGAS_string & inKey
                                                                                      COMMA_LOCATION_ARGS) {
  cMapElement * p = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
  cMapElement_M_5F_tasks * result = (cMapElement_M_5F_tasks *) p ;
...
cMapElement_M_5F_tasks * GALGAS_M_5F_tasks::readWriteAccessForWithInstruction_searchKey (C_Compiler * inCompiler,
                                                                                         const GALGAS_lstring & inKey
                                                                                         COMMA_LOCATION_ARGS) {
  cMapElement * p = searchForReadWriteAttribute (inKey, inCompiler, kSearchErrorMessage_M_5F_tasks_searchKey COMMA_THERE) ;
  cMapElement_M_5F_tasks * result = (cMapElement_M_5F_tasks *) p ;
  macroNullOrValidSharedObject (result, cMapElement_M_5F_tasks) ;
  return result ;
}
...
GALGAS_M_5F_tasks_3A_element cEnumerator_M_5F_tasks::current (LOCATION_ARGS) const {
  const cMapElement_M_5F_tasks * p = (const cMapElement_M_5F_tasks *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_M_5F_tasks) ;
  return GALGAS_M_5F_tasks_3A_element (p->mAttribute_lkey, p->mAttribute_mIndex, p->mAttribute_mPriority, p->mAttribute_mOffset, p->mAttribute_mDeadline, p->mAttribute_mDurationMin, p->mAttribute_mDurationMax, p->mAttribute_mProcessor, p->mAttribute_mPeriod, p->mAttribute_mTaskKind) ;
}
...
GALGAS_M_5F_tasks GALGAS_M_5F_tasks::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_M_5F_tasks *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "M_tasks", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_AC_5F_canMessage) ;
}
...
GALGAS_AC_5F_canMessage GALGAS_AC_5F_canMessage::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_AC_5F_canMessage *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "AC_canMessage", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_AC_5F_canMessage (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_C_5F_canIndependantMessage) ;
}
...
GALGAS_C_5F_canIndependantMessage GALGAS_C_5F_canIndependantMessage::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_C_5F_canIndependantMessage *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "C_canIndependantMessage", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_C_5F_canMessageFromMessage::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_C_5F_canMessageFromMessage) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_canMessage (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_C_5F_canMessageFromMessage) ;
}
...
GALGAS_C_5F_canMessageFromMessage GALGAS_C_5F_canMessageFromMessage::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_C_5F_canMessageFromMessage *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "C_canMessageFromMessage", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_C_5F_canMessageFromTask::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_C_5F_canMessageFromTask) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_canMessage (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_C_5F_canMessageFromTask) ;
}
...
GALGAS_C_5F_canMessageFromTask GALGAS_C_5F_canMessageFromTask::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_C_5F_canMessageFromTask *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "C_canMessageFromTask", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_AC_5F_task) ;
}
...
GALGAS_AC_5F_task GALGAS_AC_5F_task::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_AC_5F_task *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "AC_task", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_AC_5F_task (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_C_5F_independantTask) ;
}
...
GALGAS_C_5F_independantTask GALGAS_C_5F_independantTask::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_C_5F_independantTask *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "C_independantTask", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_C_5F_taskDependsFromMessage::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_C_5F_taskDependsFromMessage) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_task (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_C_5F_taskDependsFromMessage) ;
}
...
GALGAS_C_5F_taskDependsFromMessage GALGAS_C_5F_taskDependsFromMessage::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_C_5F_taskDependsFromMessage *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "C_taskDependsFromMessage", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_C_5F_taskDependsFromTask::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_C_5F_taskDependsFromTask) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_task (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_C_5F_taskDependsFromTask) ;
}
...
GALGAS_C_5F_taskDependsFromTask GALGAS_C_5F_taskDependsFromTask::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_C_5F_taskDependsFromTask *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "C_taskDependsFromTask", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_M_5F_processor_3A_element::GALGAS_M_5F_processor_3A_element (void) :
mAttribute_lkey (),
mAttribute_mIndex (),
mAttribute_mStep () {
}
...
GALGAS_M_5F_processor_3A_element::GALGAS_M_5F_processor_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_M_5F_processor_3A_element & GALGAS_M_5F_processor_3A_element::operator = (const GALGAS_M_5F_processor_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mIndex = inOperand.mAttribute_mIndex ;
  mAttribute_mStep = inOperand.mAttribute_mStep ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_M_5F_processor_3A_element GALGAS_M_5F_processor_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_uint & inOperand1,
                                                                                    const GALGAS_luint & inOperand2 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_M_5F_processor_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_M_5F_processor_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_M_5F_processor_3A_element::objectCompare (const GALGAS_M_5F_processor_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
...
bool GALGAS_M_5F_processor_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mIndex.isValid () && mAttribute_mStep.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_M_5F_processor_3A_element::drop (void) {
...
void GALGAS_M_5F_processor_3A_element::description (C_String & ioString,
                                                    const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_M_5F_processor_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_M_5F_processor_3A_element::reader_mIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_processor_3A_element::reader_mStep (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_M_5F_processor_3A_element ("M_processor:element",
                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_M_5F_processor_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_M_5F_processor_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_M_5F_processor_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_M_5F_processor_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_M_5F_processor_3A_element GALGAS_M_5F_processor_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler,
                                                                                  const GALGAS_location & inErrorLocation
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_M_5F_processor_3A_element result ;
  const GALGAS_M_5F_processor_3A_element * p = (const GALGAS_M_5F_processor_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_M_5F_processor_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "M_processor:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_M_5F_network_3A_element::GALGAS_M_5F_network_3A_element (void) :
mAttribute_lkey (),
mAttribute_mIndex (),
...
GALGAS_M_5F_network_3A_element::GALGAS_M_5F_network_3A_element (const GALGAS_lstring & inOperand0,
                                                                const GALGAS_uint & inOperand1,
...
/* GALGAS_M_5F_network_3A_element & GALGAS_M_5F_network_3A_element::operator = (const GALGAS_M_5F_network_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mIndex = inOperand.mAttribute_mIndex ;
  mAttribute_mCANnetwork = inOperand.mAttribute_mCANnetwork ;
  mAttribute_mScalingFactor = inOperand.mAttribute_mScalingFactor ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_M_5F_network_3A_element GALGAS_M_5F_network_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                const GALGAS_uint & inOperand1,
                                                                                const GALGAS_bool & inOperand2,
                                                                                const GALGAS_luint & inOperand3 
                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_M_5F_network_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_M_5F_network_3A_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_M_5F_network_3A_element::objectCompare (const GALGAS_M_5F_network_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_M_5F_network_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mIndex.isValid () && mAttribute_mCANnetwork.isValid () && mAttribute_mScalingFactor.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_M_5F_network_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mIndex.drop () ;
...
void GALGAS_M_5F_network_3A_element::description (C_String & ioString,
                                                  const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_M_5F_network_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_M_5F_network_3A_element::reader_mIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_M_5F_network_3A_element::reader_mCANnetwork (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mCANnetwork ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_network_3A_element::reader_mScalingFactor (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_M_5F_network_3A_element ("M_network:element",
                                                NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_M_5F_network_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_M_5F_network_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_M_5F_network_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_M_5F_network_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_M_5F_network_3A_element GALGAS_M_5F_network_3A_element::extractObject (const GALGAS_object & inObject,
                                                                              C_Compiler * inCompiler,
                                                                              const GALGAS_location & inErrorLocation
                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_M_5F_network_3A_element result ;
  const GALGAS_M_5F_network_3A_element * p = (const GALGAS_M_5F_network_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_M_5F_network_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "M_network:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_M_5F_messages_3A_element::GALGAS_M_5F_messages_3A_element (void) :
mAttribute_lkey (),
mAttribute_mIndex (),
mAttribute_mClass (),
...
GALGAS_M_5F_messages_3A_element::GALGAS_M_5F_messages_3A_element (const GALGAS_lstring & inOperand0,
                                                                  const GALGAS_uint & inOperand1,
                                                                  const GALGAS_luint & inOperand2,
...
/* GALGAS_M_5F_messages_3A_element & GALGAS_M_5F_messages_3A_element::operator = (const GALGAS_M_5F_messages_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mIndex = inOperand.mAttribute_mIndex ;
  mAttribute_mClass = inOperand.mAttribute_mClass ;
  mAttribute_mNetworkIndex = inOperand.mAttribute_mNetworkIndex ;
  mAttribute_mBytesCount = inOperand.mAttribute_mBytesCount ;
  mAttribute_mPriority = inOperand.mAttribute_mPriority ;
  mAttribute_mOffset = inOperand.mAttribute_mOffset ;
  mAttribute_mDeadline = inOperand.mAttribute_mDeadline ;
  mAttribute_mPeriod = inOperand.mAttribute_mPeriod ;
  mAttribute_mMessageKind = inOperand.mAttribute_mMessageKind ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_M_5F_messages_3A_element GALGAS_M_5F_messages_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                  const GALGAS_uint & inOperand1,
                                                                                  const GALGAS_luint & inOperand2,
                                                                                  const GALGAS_uint & inOperand3,
                                                                                  const GALGAS_luint & inOperand4,
                                                                                  ...
                                                                                  const GALGAS_AC_5F_canMessage & inOperand9 
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_M_5F_messages_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid ()) {
    result = GALGAS_M_5F_messages_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_M_5F_messages_3A_element::objectCompare (const GALGAS_M_5F_messages_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_M_5F_messages_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mIndex.isValid () && mAttribute_mClass.isValid () && mAttribute_mNetworkIndex.isValid () && mAttribute_mBytesCount.isValid () && mAttribute_mPriority.isValid () && mAttribute_mOffset.isValid () && mAttribute_mDeadline.isValid () && mAttribute_mPeriod.isValid () && mAttribute_mMessageKind.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_M_5F_messages_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mIndex.drop () ;
...
void GALGAS_M_5F_messages_3A_element::description (C_String & ioString,
                                                   const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_M_5F_messages_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_M_5F_messages_3A_element::reader_mIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_messages_3A_element::reader_mClass (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mClass ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_M_5F_messages_3A_element::reader_mNetworkIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mNetworkIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_messages_3A_element::reader_mBytesCount (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBytesCount ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_messages_3A_element::reader_mPriority (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPriority ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_messages_3A_element::reader_mOffset (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOffset ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_messages_3A_element::reader_mDeadline (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDeadline ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_messages_3A_element::reader_mPeriod (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPeriod ;
}

//---------------------------------------------------------------------------*

GALGAS_AC_5F_canMessage GALGAS_M_5F_messages_3A_element::reader_mMessageKind (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_M_5F_messages_3A_element ("M_messages:element",
                                                 NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_M_5F_messages_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_M_5F_messages_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_M_5F_messages_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_M_5F_messages_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_M_5F_messages_3A_element GALGAS_M_5F_messages_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                C_Compiler * inCompiler,
                                                                                const GALGAS_location & inErrorLocation
                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_M_5F_messages_3A_element result ;
  const GALGAS_M_5F_messages_3A_element * p = (const GALGAS_M_5F_messages_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_M_5F_messages_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "M_messages:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_M_5F_tasks_3A_element::GALGAS_M_5F_tasks_3A_element (void) :
mAttribute_lkey (),
mAttribute_mIndex (),
mAttribute_mPriority (),
mAttribute_mOffset (),
...
GALGAS_M_5F_tasks_3A_element::GALGAS_M_5F_tasks_3A_element (const GALGAS_lstring & inOperand0,
                                                            const GALGAS_uint & inOperand1,
                                                            const GALGAS_luint & inOperand2,
                                                            const GALGAS_luint & inOperand3,
                                                            const GALGAS_luint & inOperand4,
...
/* GALGAS_M_5F_tasks_3A_element & GALGAS_M_5F_tasks_3A_element::operator = (const GALGAS_M_5F_tasks_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mIndex = inOperand.mAttribute_mIndex ;
  mAttribute_mPriority = inOperand.mAttribute_mPriority ;
  mAttribute_mOffset = inOperand.mAttribute_mOffset ;
  mAttribute_mDeadline = inOperand.mAttribute_mDeadline ;
  mAttribute_mDurationMin = inOperand.mAttribute_mDurationMin ;
  mAttribute_mDurationMax = inOperand.mAttribute_mDurationMax ;
  mAttribute_mProcessor = inOperand.mAttribute_mProcessor ;
  mAttribute_mPeriod = inOperand.mAttribute_mPeriod ;
  mAttribute_mTaskKind = inOperand.mAttribute_mTaskKind ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_M_5F_tasks_3A_element GALGAS_M_5F_tasks_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                            const GALGAS_uint & inOperand1,
                                                                            const GALGAS_luint & inOperand2,
                                                                            const GALGAS_luint & inOperand3,
                                                                            const GALGAS_luint & inOperand4,
                                                                            ...
                                                                            const GALGAS_AC_5F_task & inOperand9 
                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_M_5F_tasks_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid ()) {
    result = GALGAS_M_5F_tasks_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_M_5F_tasks_3A_element::objectCompare (const GALGAS_M_5F_tasks_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_M_5F_tasks_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mIndex.isValid () && mAttribute_mPriority.isValid () && mAttribute_mOffset.isValid () && mAttribute_mDeadline.isValid () && mAttribute_mDurationMin.isValid () && mAttribute_mDurationMax.isValid () && mAttribute_mProcessor.isValid () && mAttribute_mPeriod.isValid () && mAttribute_mTaskKind.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_M_5F_tasks_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mIndex.drop () ;
  mAttribute_mPriority.drop () ;
  mAttribute_mOffset.drop () ;
...
void GALGAS_M_5F_tasks_3A_element::description (C_String & ioString,
                                                const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_M_5F_tasks_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_M_5F_tasks_3A_element::reader_mIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_tasks_3A_element::reader_mPriority (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPriority ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_tasks_3A_element::reader_mOffset (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOffset ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_tasks_3A_element::reader_mDeadline (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDeadline ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_tasks_3A_element::reader_mDurationMin (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDurationMin ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_tasks_3A_element::reader_mDurationMax (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDurationMax ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_M_5F_tasks_3A_element::reader_mProcessor (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mProcessor ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_tasks_3A_element::reader_mPeriod (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPeriod ;
}

//---------------------------------------------------------------------------*

GALGAS_AC_5F_task GALGAS_M_5F_tasks_3A_element::reader_mTaskKind (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_M_5F_tasks_3A_element ("M_tasks:element",
                                              NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_M_5F_tasks_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_M_5F_tasks_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_M_5F_tasks_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_M_5F_tasks_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_M_5F_tasks_3A_element GALGAS_M_5F_tasks_3A_element::extractObject (const GALGAS_object & inObject,
                                                                          C_Compiler * inCompiler,
                                                                          const GALGAS_location & inErrorLocation
                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_M_5F_tasks_3A_element result ;
  const GALGAS_M_5F_tasks_3A_element * p = (const GALGAS_M_5F_tasks_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_M_5F_tasks_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "M_tasks:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
