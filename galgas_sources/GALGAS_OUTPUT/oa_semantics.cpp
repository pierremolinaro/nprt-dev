...
GGS_C_canIndependantMessage::
GGS_C_canIndependantMessage (const GGS_C_canIndependantMessage & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_C_canMessageFromMessage::
GGS_C_canMessageFromMessage (const GGS_C_canMessageFromMessage & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_C_canMessageFromTask::
GGS_C_canMessageFromTask (const GGS_C_canMessageFromTask & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_C_independantTask::
GGS_C_independantTask (const GGS_C_independantTask & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_C_taskDependsFromTask::
GGS_C_taskDependsFromTask (const GGS_C_taskDependsFromTask & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_C_taskDependsFromMessage::
GGS_C_taskDependsFromMessage (const GGS_C_taskDependsFromMessage & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
