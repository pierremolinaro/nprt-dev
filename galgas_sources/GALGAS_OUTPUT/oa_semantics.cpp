...
appendForMapDescription (C_String & ioString) const {
  ...
  ioString << "->" ;
  ioString << mInfo.mStep.reader_description () ;
  ioString << "]" ;
}
...
GGS_M_processor GGS_M_processor::constructor_empty (UNUSED_LOCATION_ARGS) {
...
GGS_string GGS_M_processor::reader_description (void) const {
  C_String s ;
  s << "<map @M_processor " ;
  if (isBuilt ()) {
...
appendForMapDescription (C_String & ioString) const {
  ioString << "["
           << mKey.reader_description () ;
  ioString << "->" ;
  ioString << mInfo.mCANnetwork.reader_description () ;
  ioString << mInfo.mScalingFactor.reader_description () ;
  ioString << "]" ;
}
...
GGS_M_network GGS_M_network::constructor_empty (UNUSED_LOCATION_ARGS) {
...
GGS_string GGS_M_network::reader_description (void) const {
  C_String s ;
  s << "<map @M_network " ;
  if (isBuilt ()) {
    s << count () << " object" << ((count () > 1) ? "s " : " ") ;
...
void cPtr_C_canIndependantMessage::appendForDescription (C_String & ioString) const {
...
void cPtr_C_canMessageFromMessage::appendForDescription (C_String & ioString) const {
  ioString << "->@C_canMessageFromMessage:" ;
mMessageIndex.reader_description () ;
}
...
void cPtr_C_canMessageFromTask::appendForDescription (C_String & ioString) const {
  ioString << "->@C_canMessageFromTask:" ;
mTaskIndex.reader_description () ;
}
...
appendForMapDescription (C_String & ioString) const {
  ioString << "["
           << mKey.reader_description () ;
  ioString << "->" ;
  ioString << mInfo.mClass.reader_description () ;
  ioString << mInfo.mNetworkIndex.reader_description () ;
  ioString << mInfo.mBytesCount.reader_description () ;
  ioString << mInfo.mPriority.reader_description () ;
  ioString << mInfo.mOffset.reader_description () ;
  ioString << mInfo.mDeadline.reader_description () ;
  ioString << mInfo.mPeriod.reader_description () ;
  ioString << mInfo.mMessageKind.reader_description () ;
  ioString << "]" ;
}
...
GGS_M_messages GGS_M_messages::constructor_empty (UNUSED_LOCATION_ARGS) {
...
GGS_string GGS_M_messages::reader_description (void) const {
  C_String s ;
  s << "<map @M_messages " ;
  if (isBuilt ()) {
    s << count () << " object" << ((count () > 1) ? "s " : " ") ;
...
void cPtr_C_independantTask::appendForDescription (C_String & ioString) const {
...
void cPtr_C_taskDependsFromTask::appendForDescription (C_String & ioString) const {
  ioString << "->@C_taskDependsFromTask:" ;
mTask.reader_description () ;
mEvery.reader_description () ;
}
...
void cPtr_C_taskDependsFromMessage::appendForDescription (C_String & ioString) const {
  ioString << "->@C_taskDependsFromMessage:" ;
mMessage.reader_description () ;
mEvery.reader_description () ;
}
...
appendForMapDescription (C_String & ioString) const {
  ...
  ioString << mInfo.mOffset.reader_description () ;
  ioString << mInfo.mDeadline.reader_description () ;
  ioString << mInfo.mDurationMin.reader_description () ;
  ioString << mInfo.mDurationMax.reader_description () ;
  ioString << mInfo.mProcessor.reader_description () ;
  ioString << mInfo.mPeriod.reader_description () ;
  ioString << mInfo.mTaskKind.reader_description () ;
  ioString << "]" ;
}
...
GGS_M_tasks GGS_M_tasks::constructor_empty (UNUSED_LOCATION_ARGS) {
  GGS_M_tasks result ;
  macroMyNew (result.mReferenceCountPtr, sint32 (1)) ;
  return result ;
}
...
GGS_string GGS_M_tasks::reader_description (void) const {
  C_String s ;
  s << "<map @M_tasks " ;
  if (isBuilt ()) {
    s << count () << " object" << ((count () > 1) ? "s " : " ") ;
