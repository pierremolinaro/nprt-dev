...
GALGAS_M_5F_processor_2E_element cEnumerator_M_5F_processor::current (LOCATION_ARGS) const {
  const cMapElement_M_5F_processor * p = (const cMapElement_M_5F_processor *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_M_5F_processor) ;
  return GALGAS_M_5F_processor_2E_element (p->mAttribute_lkey, p->mAttribute_mIndex, p->mAttribute_mStep) ;
}
...
GALGAS_M_5F_network_2E_element cEnumerator_M_5F_network::current (LOCATION_ARGS) const {
  const cMapElement_M_5F_network * p = (const cMapElement_M_5F_network *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_M_5F_network) ;
  return GALGAS_M_5F_network_2E_element (p->mAttribute_lkey, p->mAttribute_mIndex, p->mAttribute_mCANnetwork, p->mAttribute_mScalingFactor) ;
}
...
GALGAS_M_5F_messages_2E_element cEnumerator_M_5F_messages::current (LOCATION_ARGS) const {
  const cMapElement_M_5F_messages * p = (const cMapElement_M_5F_messages *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_M_5F_messages) ;
  return GALGAS_M_5F_messages_2E_element (p->mAttribute_lkey, p->mAttribute_mIndex, p->mAttribute_mClass, p->mAttribute_mNetworkIndex, p->mAttribute_mBytesCount, p->mAttribute_mPriority, p->mAttribute_mOffset, p->mAttribute_mDeadline, p->mAttribute_mPeriod, p->mAttribute_mMessageKind) ;
}
...
GALGAS_M_5F_tasks_2E_element cEnumerator_M_5F_tasks::current (LOCATION_ARGS) const {
  const cMapElement_M_5F_tasks * p = (const cMapElement_M_5F_tasks *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_M_5F_tasks) ;
  return GALGAS_M_5F_tasks_2E_element (p->mAttribute_lkey, p->mAttribute_mIndex, p->mAttribute_mPriority, p->mAttribute_mOffset, p->mAttribute_mDeadline, p->mAttribute_mDurationMin, p->mAttribute_mDurationMax, p->mAttribute_mProcessor, p->mAttribute_mPeriod, p->mAttribute_mTaskKind) ;
}
...
GALGAS_M_5F_processor_2E_element::GALGAS_M_5F_processor_2E_element (void) :
mAttribute_lkey (),
mAttribute_mIndex (),
mAttribute_mStep () {
}
...
GALGAS_M_5F_processor_2E_element::GALGAS_M_5F_processor_2E_element (const GALGAS_lstring & inOperand0,
...
GALGAS_M_5F_processor_2E_element GALGAS_M_5F_processor_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_M_5F_processor_2E_element (GALGAS_lstring::constructor_default (HERE),
...
GALGAS_M_5F_processor_2E_element GALGAS_M_5F_processor_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_uint & inOperand1,
                                                                                    const GALGAS_luint & inOperand2 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_M_5F_processor_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_M_5F_processor_2E_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_M_5F_processor_2E_element::objectCompare (const GALGAS_M_5F_processor_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
...
bool GALGAS_M_5F_processor_2E_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mIndex.isValid () && mAttribute_mStep.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_M_5F_processor_2E_element::drop (void) {
...
void GALGAS_M_5F_processor_2E_element::description (C_String & ioString,
                                                    const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_M_5F_processor_2E_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_M_5F_processor_2E_element::reader_mIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_processor_2E_element::reader_mStep (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_M_5F_processor_2E_element ("M_processor.element",
                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_M_5F_processor_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_M_5F_processor_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_M_5F_processor_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_M_5F_processor_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_M_5F_processor_2E_element GALGAS_M_5F_processor_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler,
                                                                                  const GALGAS_location & inErrorLocation
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_M_5F_processor_2E_element result ;
  const GALGAS_M_5F_processor_2E_element * p = (const GALGAS_M_5F_processor_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_M_5F_processor_2E_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_M_5F_network_2E_element::GALGAS_M_5F_network_2E_element (void) :
mAttribute_lkey (),
mAttribute_mIndex (),
...
GALGAS_M_5F_network_2E_element::GALGAS_M_5F_network_2E_element (const GALGAS_lstring & inOperand0,
                                                                const GALGAS_uint & inOperand1,
...
GALGAS_M_5F_network_2E_element GALGAS_M_5F_network_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_M_5F_network_2E_element (GALGAS_lstring::constructor_default (HERE),
                                         GALGAS_uint::constructor_default (HERE),
...
GALGAS_M_5F_network_2E_element GALGAS_M_5F_network_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                const GALGAS_uint & inOperand1,
                                                                                const GALGAS_bool & inOperand2,
                                                                                const GALGAS_luint & inOperand3 
                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_M_5F_network_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_M_5F_network_2E_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_M_5F_network_2E_element::objectCompare (const GALGAS_M_5F_network_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_M_5F_network_2E_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mIndex.isValid () && mAttribute_mCANnetwork.isValid () && mAttribute_mScalingFactor.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_M_5F_network_2E_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mIndex.drop () ;
...
void GALGAS_M_5F_network_2E_element::description (C_String & ioString,
                                                  const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_M_5F_network_2E_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_M_5F_network_2E_element::reader_mIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_M_5F_network_2E_element::reader_mCANnetwork (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mCANnetwork ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_network_2E_element::reader_mScalingFactor (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_M_5F_network_2E_element ("M_network.element",
                                                NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_M_5F_network_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_M_5F_network_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_M_5F_network_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_M_5F_network_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_M_5F_network_2E_element GALGAS_M_5F_network_2E_element::extractObject (const GALGAS_object & inObject,
                                                                              C_Compiler * inCompiler,
                                                                              const GALGAS_location & inErrorLocation
                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_M_5F_network_2E_element result ;
  const GALGAS_M_5F_network_2E_element * p = (const GALGAS_M_5F_network_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_M_5F_network_2E_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_M_5F_messages_2E_element::GALGAS_M_5F_messages_2E_element (void) :
mAttribute_lkey (),
mAttribute_mIndex (),
mAttribute_mClass (),
...
GALGAS_M_5F_messages_2E_element::GALGAS_M_5F_messages_2E_element (const GALGAS_lstring & inOperand0,
                                                                  const GALGAS_uint & inOperand1,
                                                                  const GALGAS_luint & inOperand2,
...
GALGAS_M_5F_messages_2E_element GALGAS_M_5F_messages_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                  const GALGAS_uint & inOperand1,
                                                                                  const GALGAS_luint & inOperand2,
                                                                                  const GALGAS_uint & inOperand3,
                                                                                  const GALGAS_luint & inOperand4,
                                                                                  ...
                                                                                  const GALGAS_AC_5F_canMessage & inOperand9 
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_M_5F_messages_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid ()) {
    result = GALGAS_M_5F_messages_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_M_5F_messages_2E_element::objectCompare (const GALGAS_M_5F_messages_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_M_5F_messages_2E_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mIndex.isValid () && mAttribute_mClass.isValid () && mAttribute_mNetworkIndex.isValid () && mAttribute_mBytesCount.isValid () && mAttribute_mPriority.isValid () && mAttribute_mOffset.isValid () && mAttribute_mDeadline.isValid () && mAttribute_mPeriod.isValid () && mAttribute_mMessageKind.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_M_5F_messages_2E_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mIndex.drop () ;
...
void GALGAS_M_5F_messages_2E_element::description (C_String & ioString,
                                                   const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_M_5F_messages_2E_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_M_5F_messages_2E_element::reader_mIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_messages_2E_element::reader_mClass (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mClass ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_M_5F_messages_2E_element::reader_mNetworkIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mNetworkIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_messages_2E_element::reader_mBytesCount (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBytesCount ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_messages_2E_element::reader_mPriority (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPriority ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_messages_2E_element::reader_mOffset (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOffset ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_messages_2E_element::reader_mDeadline (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDeadline ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_messages_2E_element::reader_mPeriod (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPeriod ;
}

//---------------------------------------------------------------------------*

GALGAS_AC_5F_canMessage GALGAS_M_5F_messages_2E_element::reader_mMessageKind (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_M_5F_messages_2E_element ("M_messages.element",
                                                 NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_M_5F_messages_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_M_5F_messages_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_M_5F_messages_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_M_5F_messages_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_M_5F_messages_2E_element GALGAS_M_5F_messages_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                C_Compiler * inCompiler,
                                                                                const GALGAS_location & inErrorLocation
                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_M_5F_messages_2E_element result ;
  const GALGAS_M_5F_messages_2E_element * p = (const GALGAS_M_5F_messages_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_M_5F_messages_2E_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_M_5F_tasks_2E_element::GALGAS_M_5F_tasks_2E_element (void) :
mAttribute_lkey (),
mAttribute_mIndex (),
mAttribute_mPriority (),
mAttribute_mOffset (),
...
GALGAS_M_5F_tasks_2E_element::GALGAS_M_5F_tasks_2E_element (const GALGAS_lstring & inOperand0,
                                                            const GALGAS_uint & inOperand1,
                                                            const GALGAS_luint & inOperand2,
                                                            const GALGAS_luint & inOperand3,
                                                            const GALGAS_luint & inOperand4,
...
GALGAS_M_5F_tasks_2E_element GALGAS_M_5F_tasks_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                            const GALGAS_uint & inOperand1,
                                                                            const GALGAS_luint & inOperand2,
                                                                            const GALGAS_luint & inOperand3,
                                                                            const GALGAS_luint & inOperand4,
                                                                            ...
                                                                            const GALGAS_AC_5F_task & inOperand9 
                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_M_5F_tasks_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid ()) {
    result = GALGAS_M_5F_tasks_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_M_5F_tasks_2E_element::objectCompare (const GALGAS_M_5F_tasks_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_M_5F_tasks_2E_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mIndex.isValid () && mAttribute_mPriority.isValid () && mAttribute_mOffset.isValid () && mAttribute_mDeadline.isValid () && mAttribute_mDurationMin.isValid () && mAttribute_mDurationMax.isValid () && mAttribute_mProcessor.isValid () && mAttribute_mPeriod.isValid () && mAttribute_mTaskKind.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_M_5F_tasks_2E_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mIndex.drop () ;
  mAttribute_mPriority.drop () ;
  mAttribute_mOffset.drop () ;
...
void GALGAS_M_5F_tasks_2E_element::description (C_String & ioString,
                                                const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_M_5F_tasks_2E_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_M_5F_tasks_2E_element::reader_mIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_tasks_2E_element::reader_mPriority (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPriority ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_tasks_2E_element::reader_mOffset (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOffset ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_tasks_2E_element::reader_mDeadline (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDeadline ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_tasks_2E_element::reader_mDurationMin (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDurationMin ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_tasks_2E_element::reader_mDurationMax (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDurationMax ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_M_5F_tasks_2E_element::reader_mProcessor (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mProcessor ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_M_5F_tasks_2E_element::reader_mPeriod (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPeriod ;
}

//---------------------------------------------------------------------------*

GALGAS_AC_5F_task GALGAS_M_5F_tasks_2E_element::reader_mTaskKind (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_M_5F_tasks_2E_element ("M_tasks.element",
                                              NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_M_5F_tasks_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_M_5F_tasks_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_M_5F_tasks_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_M_5F_tasks_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_M_5F_tasks_2E_element GALGAS_M_5F_tasks_2E_element::extractObject (const GALGAS_object & inObject,
                                                                          C_Compiler * inCompiler,
                                                                          const GALGAS_location & inErrorLocation
                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_M_5F_tasks_2E_element result ;
  const GALGAS_M_5F_tasks_2E_element * p = (const GALGAS_M_5F_tasks_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_M_5F_tasks_2E_element *> (p)) {
      result = *p ;
    }else{
