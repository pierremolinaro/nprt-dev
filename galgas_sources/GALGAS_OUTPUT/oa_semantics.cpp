...
cPtr_C_canMessageFromMessage (const GGS_luint & argument_0 COMMA_LOCATION_ARGS)
:cPtr_AC_canMessage (THERE),
...
cPtr_C_canMessageFromTask (const GGS_luint & argument_0 COMMA_LOCATION_ARGS)
:cPtr_AC_canMessage (THERE),
