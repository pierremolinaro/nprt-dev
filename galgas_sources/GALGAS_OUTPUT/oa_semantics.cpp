...
AC_galgas_map_elementEx * GGS_M_processor::
...
void GGS_M_processor::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
...
AC_galgas_map_elementEx * GGS_M_network::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_network::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_M_messages::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_messages::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_M_tasks::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_tasks::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
