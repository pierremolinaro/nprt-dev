...
void GGS_M_processor::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_luint & inParameter0) {
  const char * kErrorMessage [] = {"the processor '",
...
void GGS_M_network::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_bool& inParameter0,
                                const GGS_luint & inParameter1) {
...
void GGS_M_messages::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_luint & inParameter0,
                                const GGS_luint & inParameter1,
...
void GGS_M_tasks::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_luint & inParameter0,
                                const GGS_luint & inParameter1,
