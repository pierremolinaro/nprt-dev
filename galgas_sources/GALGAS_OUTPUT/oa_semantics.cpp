...
_operator_isEqual (const GGS_AC_canMessage & inOperand) const {
...
GGS_bool GGS_AC_canMessage::
_operator_isNotEqual (const GGS_AC_canMessage & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_C_canIndependantMessage::
GGS_C_canIndependantMessage (const GGS_C_canIndependantMessage & inOperand)
:GGS_AC_canMessage () {
  macroAssignPointer (mPointer, inOperand.mPointer) ;
}
...
GGS_C_canIndependantMessage::
~GGS_C_canIndependantMessage (void) {
  macroDetachPointer (mPointer, cPtr_C_canIndependantMessage) ;
}

//---------------------------------------------------------------------------*

void GGS_C_canIndependantMessage::
operator = (const GGS_C_canIndependantMessage & inSource) {
  macroAssignPointer (mPointer, inSource.mPointer) ;
}
...
constructor_new (C_Compiler & /* inLexique */
  ...
  macroMyNew (result.mPointer, cPtr_C_canIndependantMessage (THERE)) ;
  return result ;
}
...
_operator_isEqual (const GGS_C_canIndependantMessage & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_canIndependantMessage::
_operator_isNotEqual (const GGS_C_canIndependantMessage & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_C_canMessageFromMessage::
GGS_C_canMessageFromMessage (const GGS_C_canMessageFromMessage & inOperand)
:GGS_AC_canMessage () {
  macroAssignPointer (mPointer, inOperand.mPointer) ;
}
...
GGS_C_canMessageFromMessage::
~GGS_C_canMessageFromMessage (void) {
  macroDetachPointer (mPointer, cPtr_C_canMessageFromMessage) ;
}

//---------------------------------------------------------------------------*

void GGS_C_canMessageFromMessage::
operator = (const GGS_C_canMessageFromMessage & inSource) {
  macroAssignPointer (mPointer, inSource.mPointer) ;
}
...
_operator_isEqual (const GGS_C_canMessageFromMessage & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_canMessageFromMessage::
_operator_isNotEqual (const GGS_C_canMessageFromMessage & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_C_canMessageFromTask::
GGS_C_canMessageFromTask (const GGS_C_canMessageFromTask & inOperand)
:GGS_AC_canMessage () {
  macroAssignPointer (mPointer, inOperand.mPointer) ;
}
...
GGS_C_canMessageFromTask::
~GGS_C_canMessageFromTask (void) {
  macroDetachPointer (mPointer, cPtr_C_canMessageFromTask) ;
}

//---------------------------------------------------------------------------*

void GGS_C_canMessageFromTask::
operator = (const GGS_C_canMessageFromTask & inSource) {
  macroAssignPointer (mPointer, inSource.mPointer) ;
}
...
_operator_isEqual (const GGS_C_canMessageFromTask & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_canMessageFromTask::
_operator_isNotEqual (const GGS_C_canMessageFromTask & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_AC_task & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_AC_task::
_operator_isNotEqual (const GGS_AC_task & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_C_independantTask::
GGS_C_independantTask (const GGS_C_independantTask & inOperand)
:GGS_AC_task () {
  macroAssignPointer (mPointer, inOperand.mPointer) ;
}
...
GGS_C_independantTask::
~GGS_C_independantTask (void) {
  macroDetachPointer (mPointer, cPtr_C_independantTask) ;
}

//---------------------------------------------------------------------------*

void GGS_C_independantTask::
operator = (const GGS_C_independantTask & inSource) {
  macroAssignPointer (mPointer, inSource.mPointer) ;
}
...
constructor_new (C_Compiler & /* inLexique */
  ...
  macroMyNew (result.mPointer, cPtr_C_independantTask (THERE)) ;
  return result ;
}
...
_operator_isEqual (const GGS_C_independantTask & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_independantTask::
_operator_isNotEqual (const GGS_C_independantTask & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_C_taskDependsFromTask::
GGS_C_taskDependsFromTask (const GGS_C_taskDependsFromTask & inOperand)
:GGS_AC_task () {
  macroAssignPointer (mPointer, inOperand.mPointer) ;
}
...
GGS_C_taskDependsFromTask::
~GGS_C_taskDependsFromTask (void) {
  macroDetachPointer (mPointer, cPtr_C_taskDependsFromTask) ;
}

//---------------------------------------------------------------------------*

void GGS_C_taskDependsFromTask::
operator = (const GGS_C_taskDependsFromTask & inSource) {
  macroAssignPointer (mPointer, inSource.mPointer) ;
}
...
_operator_isEqual (const GGS_C_taskDependsFromTask & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_taskDependsFromTask::
_operator_isNotEqual (const GGS_C_taskDependsFromTask & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_C_taskDependsFromMessage::
GGS_C_taskDependsFromMessage (const GGS_C_taskDependsFromMessage & inOperand)
:GGS_AC_task () {
  macroAssignPointer (mPointer, inOperand.mPointer) ;
}
...
GGS_C_taskDependsFromMessage::
~GGS_C_taskDependsFromMessage (void) {
  macroDetachPointer (mPointer, cPtr_C_taskDependsFromMessage) ;
}

//---------------------------------------------------------------------------*

void GGS_C_taskDependsFromMessage::
operator = (const GGS_C_taskDependsFromMessage & inSource) {
  macroAssignPointer (mPointer, inSource.mPointer) ;
}
...
_operator_isEqual (const GGS_C_taskDependsFromMessage & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_taskDependsFromMessage::
_operator_isNotEqual (const GGS_C_taskDependsFromMessage & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
