...
void C_Lexique_oa_5F_scanner::assignFromAttribute_identifierString (GGS_lstring & outValue) const {
  cTokenFor_oa_5F_scanner * ptr = (cTokenFor_oa_5F_scanner *) mCurrentTokenPtr ;
...
void C_Lexique_oa_5F_scanner::assignFromAttribute_ulongValue (GGS_luint & outValue) const {
  cTokenFor_oa_5F_scanner * ptr = (cTokenFor_oa_5F_scanner *) mCurrentTokenPtr ;
...
GALGASap_lstring C_Lexique_oa_5F_scanner::synthetizedAttribute_identifierString (void) const {
  cTokenFor_oa_5F_scanner * ptr = (cTokenFor_oa_5F_scanner *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_oa_5F_scanner) ;
...
GALGASap_luint C_Lexique_oa_5F_scanner::synthetizedAttribute_ulongValue (void) const {
  cTokenFor_oa_5F_scanner * ptr = (cTokenFor_oa_5F_scanner *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_oa_5F_scanner) ;
  GALGASap_location currentLocation (GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE)) ;
