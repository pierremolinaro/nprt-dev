...
static const C_unicode_lexique_table_entry ktable_for_delimitorsList [ktable_size_delimitorsList] = {
  C_unicode_lexique_table_entry (kUnicodeString__2C_, 1, oa_scanner::oa_scanner_1__2C_),
  C_unicode_lexique_table_entry (kUnicodeString__3B_, 1, oa_scanner::oa_scanner_1__3B_),
  C_unicode_lexique_table_entry (kUnicodeString__2E__2E_, 2, oa_scanner::oa_scanner_1__2E__2E_)
} ;

PMSInt16 oa_scanner::search_into_delimitorsList (const C_String & inSearchedString) {
...
static const C_unicode_lexique_table_entry ktable_for_keyWordList [ktable_size_keyWordList] = {
  C_unicode_lexique_table_entry (kUnicodeString_on, 2, oa_scanner::oa_scanner_1_on),
  C_unicode_lexique_table_entry (kUnicodeString_can, 3, oa_scanner::oa_scanner_1_can),
  C_unicode_lexique_table_entry (kUnicodeString_end, 3, oa_scanner::oa_scanner_1_end),
  C_unicode_lexique_table_entry (kUnicodeString_van, 3, oa_scanner::oa_scanner_1_van),
  C_unicode_lexique_table_entry (kUnicodeString_task, 4, oa_scanner::oa_scanner_1_task),
  C_unicode_lexique_table_entry (kUnicodeString_every, 5, oa_scanner::oa_scanner_1_every),
  C_unicode_lexique_table_entry (kUnicodeString_length, 6, oa_scanner::oa_scanner_1_length),
  C_unicode_lexique_table_entry (kUnicodeString_offset, 6, oa_scanner::oa_scanner_1_offset),
  C_unicode_lexique_table_entry (kUnicodeString_period, 6, oa_scanner::oa_scanner_1_period),
  C_unicode_lexique_table_entry (kUnicodeString_system, 6, oa_scanner::oa_scanner_1_system),
  C_unicode_lexique_table_entry (kUnicodeString_message, 7, oa_scanner::oa_scanner_1_message),
  C_unicode_lexique_table_entry (kUnicodeString_network, 7, oa_scanner::oa_scanner_1_network),
  C_unicode_lexique_table_entry (kUnicodeString_deadline, 8, oa_scanner::oa_scanner_1_deadline),
  C_unicode_lexique_table_entry (kUnicodeString_duration, 8, oa_scanner::oa_scanner_1_duration),
  C_unicode_lexique_table_entry (kUnicodeString_extended, 8, oa_scanner::oa_scanner_1_extended),
  C_unicode_lexique_table_entry (kUnicodeString_priority, 8, oa_scanner::oa_scanner_1_priority),
  C_unicode_lexique_table_entry (kUnicodeString_standard, 8, oa_scanner::oa_scanner_1_standard),
  C_unicode_lexique_table_entry (kUnicodeString_processor, 9, oa_scanner::oa_scanner_1_processor),
  C_unicode_lexique_table_entry (kUnicodeString_scalingfactor, 13, oa_scanner::oa_scanner_1_scalingfactor)
} ;

PMSInt16 oa_scanner::search_into_keyWordList (const C_String & inSearchedString) {
...
getCurrentTokenString (const cToken * inTokenPtr) const {
  const cTokenFor_oa_scanner * ptr = (const cTokenFor_oa_scanner *) inTokenPtr ;
  C_String s ;
  if (ptr == NULL) {
    s.appendCString("$$") ;
  }else{
