    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        if (currentTokenCode_ == -1) {
          currentTokenCode_ = oa_scanner_1_identifier ;
        }
        _enterToken (currentTokenCode_) ;
      }else if (testForInputString ("..", 2)) {
        currentTokenCode_ = oa_scanner_1__2E_2E ;
        _enterToken (oa_scanner_1__2E_2E) ;
      }else if (testForInputString (",", 1)) {
        currentTokenCode_ = oa_scanner_1__2C ;
        _enterToken (oa_scanner_1__2C) ;
      }else if (testForInputString (";", 1)) {
        currentTokenCode_ = oa_scanner_1__3B ;
        _enterToken (oa_scanner_1__3B) ;
        ...
        loop_ = true ;
        currentTokenCode_ = oa_scanner_1_literal_5Finteger ;
        _enterToken (oa_scanner_1_literal_5Finteger) ;
        ...
        currentTokenCode_ = oa_scanner_1_ ; // Empty string code
...
void oa_scanner::_enterToken (const sint16 inTokenCode) {
