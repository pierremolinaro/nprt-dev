  ...
  while ((_token.mTokenCode < 0) && (UNICODE_VALUE (mCurrentChar) != '\0')) {
    ...
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        loop_ = true ;
        _token.mTokenCode = oa_scanner_1_literal_5Finteger ;
        _enterToken (_token) ;
        ...
        _token.mTokenCode = oa_scanner_1_ ; // Empty string code
