...
void enterOptions (NSMutableArray * ioBoolOptionArray,
  ...
  enterOptionsFor_oa_5F_cli_5F_options (ioBoolOptionArray, ioUIntOptionArray, ioStringOptionArray) ;
}
...
OC_Lexique * tokenizerForExtension (const NSString * inExtension) {
  ...
  if ([inExtension isEqualToString:@"nprt"]) {
    result = [[[OC_Tokenizer_oa_scanner alloc] init] autorelease] ;
  }
  return result ;
}
...
NSArray * tokenizers (void) {
  return [NSArray arrayWithObjects:
    [[[OC_Tokenizer_oa_scanner alloc] init] autorelease],
    nil
  ] ;
}
