...
void C_Grammar_oa_5F_grammar::_performSourceStringParsing_ (C_Compiler & inCompiler,
  ...
  C_Lexique_oa_5F_scanner * scanner_ = NULL ;
  macroMyNew (scanner_, C_Lexique_oa_5F_scanner (& inCompiler, inCompiler.ioParametersPtr (), inSourceString.string (), "Error when parsing dynamic string" COMMA_HERE)) ;
  scanner_->mPerformGeneration = inCompiler.mPerformGeneration ;
  const bool ok = scanner_->performTopDownParsing (gProductions, gProductionNames, gProductionIndexes,
                                                   gFirstProductionIndexes, gDecision, gDecisionIndexes, 120) ;
  if (ok && ! scanner_->mParseOnlyFlag) {
