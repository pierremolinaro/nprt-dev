...
pr_axiome_oa_parser_13_13_ (_inLexique) ;
}
...
void oa_grammar::_performSourceFileParsing_ (C_Compiler & _inCompiler,
  ...
  if (sourceFileName.fileExists ()) {
    ...
    macroMyNew (scanner_, oa_scanner (& _inCompiler, _inDependancyExtension, _inCompiler.ioParametersPtr (), sourceFileName COMMA_HERE)) ;
