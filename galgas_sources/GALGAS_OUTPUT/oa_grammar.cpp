...
pr_axiome_oa_parser_13_13_ (inLexique) ;
}
...
void oa_grammar::_performSourceFileParsing_ (C_Compiler & _inCompiler,
  ...
  if (sourceFileName.fileExists ()) {
    ...
    macroMyNew (scanner_, oa_scanner (& _inCompiler, _inDependancyExtension, _inDependancyPath, _inCompiler.ioParametersPtr (), sourceFileName COMMA_HERE)) ;
...
void oa_grammar::_performSourceStringParsing_ (C_Compiler & _inCompiler,
  ...
  oa_scanner * scanner_ = NULL ;
  macroMyNew (scanner_, oa_scanner (& _inCompiler, _inCompiler.ioParametersPtr (), _inSourceString.string (), "Error when parsing dynamic string" COMMA_HERE)) ;
  scanner_->mPerformGeneration = _inCompiler.mPerformGeneration ;
  const bool ok = scanner_->performTopDownParsing (gProductions, gProductionNames, gProductionIndexes,
                                                   gFirstProductionIndexes, gDecision, gDecisionIndexes, 120) ;
  if (ok && ! scanner_->mParseOnlyFlag) {
...
sint16 oa_grammar::select_repeat_oa_parser_0 (oa_scanner & inLexique) {
...
sint16 oa_grammar::select_oa_parser_1 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 oa_grammar::select_oa_parser_2 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 oa_grammar::select_oa_parser_3 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 oa_grammar::select_oa_parser_4 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 oa_grammar::select_oa_parser_5 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 oa_grammar::select_oa_parser_6 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 oa_grammar::select_oa_parser_7 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 oa_grammar::select_oa_parser_8 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 oa_grammar::select_oa_parser_9 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 oa_grammar::select_oa_parser_10 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 oa_grammar::select_oa_parser_11 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 oa_grammar::select_oa_parser_12 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 oa_grammar::select_oa_parser_13 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 oa_grammar::select_oa_parser_14 (oa_scanner & inLexique) {
  return inLexique.nextProductionIndex () ;
}
