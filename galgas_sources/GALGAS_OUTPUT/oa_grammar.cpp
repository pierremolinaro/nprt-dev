...
void C_Grammar_oa_5F_grammar::_performSourceFileParsing_ (C_CompilerEx & inCompiler,
  ...
  if (sourceFileName.fileExists ()) {
    ...
    macroMyNew (scanner, C_Lexique_oa_5F_scanner (& inCompiler, inDependancyExtension, inDependancyPath, inCompiler.ioParametersPtr (), sourceFileName COMMA_HERE)) ;
...
void C_Grammar_oa_5F_grammar::_performSourceStringParsing_ (C_CompilerEx & inCompiler,
                                GGS_string * inSentStringPtr,
                                const GGS_string inSourceString
                                COMMA_UNUSED_LOCATION_ARGS) {
  C_Lexique_oa_5F_scanner * scanner = NULL ;
  macroMyNew (scanner, C_Lexique_oa_5F_scanner (& inCompiler, inCompiler.ioParametersPtr (), inSourceString.string (), "Error when parsing dynamic string" COMMA_HERE)) ;
  scanner->mPerformGeneration = inCompiler.mPerformGeneration ;
  const bool ok = scanner->performTopDownParsing (gProductions, gProductionNames, gProductionIndexes,
                                                   gFirstProductionIndexes, gDecision, gDecisionIndexes, 120) ;
  if (ok && ! scanner->mParseOnlyFlag) {
