...
uint32_t C_us_hashmap::getAllocatedSizeInBytes (void) {
...
uint32_t C_us_hashmap::C_TreeForCollision::internalRecursiveSweep (C_us_hashmap::MyBlockavltree_element_for_collision * inElement) {
...
uint32_t C_us_hashmap::C_TreeForCollision::sweepUnmarkedObjects (void) {
...
int32_t C_us_hashmap::C_TreeForCollision::
...
uint32_t C_us_hashmap::getMapSizeInBytes (void) const {
  return (uint32_t) mEntryCurrentCount * (uint32_t) sizeof (C_TreeForCollision) ;
}
