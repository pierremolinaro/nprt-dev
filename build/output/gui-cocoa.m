...
#import "lexique-oa-5Fscanner-cocoa.h"
...
static const UInt16 * gPopUpData_0_oa_5F_scanner [1] = {
  NULL
} ;
...
@interface OC_Tokenizer_0_oa_scanner : OC_Lexique_oa_scanner {
...
OC_Lexique * tokenizerForExtension (const NSString * inExtension) {
  ...
  if ([uppercasedExtension isEqualToString:@"NPRT"]) {
    result = [OC_Tokenizer_0_oa_scanner new] ;
  }
  return result ;
}
