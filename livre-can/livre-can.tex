...
%-----------------------------------------------------------------------------------------------------------------------*
%                                                                                                                       *
%   P A Q U E T A G E    « L I S T I N G S »    (pour le code C++)                                                      *
%                                                                                                                       *
%-----------------------------------------------------------------------------------------------------------------------*
%  http://pgoutet.free.fr/latex/seance_9/seance_9-bis.pdf
...
%-----------------------------------------------------------------------------------------------------------------------*
%                                                                                                                       *
%   T O C L O F T   : P O U R    É T A B L I R    L A    L I S T E    D E S    P R O G R A M M E S    S P I C E         *
%                                                                                                                       *
%-----------------------------------------------------------------------------------------------------------------------*

%http://texblog.wordpress.com/tag/listoftables/
% DOIT ÊTRE PLACÉ APRÈS HYPERREF !
\usepackage{tocloft}

\newcommand{\listprogrammesname}{Listings}

\newlistof[chapter]{programmes}{prgm}{\listprogrammesname}

\newcommand{\programmes}[2]{
  \refstepcounter{programmes}
  \par\noindent\center{\label{prgm:#1}\emph{\textbf{Listing \theprogrammes~-- }#2}}
  \addcontentsline{prgm}{programmes}
  {\protect\numberline{\theprogrammes}~~~#2}\par % Ceci est la numérotation dans la table des matières
}

\newcommand\refProgramme[1]{\hyperref[prgm:#1]{listing \ref*{prgm:#1}}}

\newcommand\refProgrammePage[1]{\hyperref[prgm:#1]{listing \ref*{prgm:#1} page \pageref{prgm:#1}}}
...
%-----------------------------------------------------------------------------------------------------------------------*
%                                                                                                                       *
%   L I S T E    D E S    P R O G R A M M E S                                                                           *
%                                                                                                                       *
%-----------------------------------------------------------------------------------------------------------------------*

\clearpage
\addtocontents{prgm}{\protect\thispagestyle{empty}\protect\pagestyle{fancy}}
\begingroup
  \tocfile{\listprogrammesname}{prgm}
\endgroup
...
\input{chapitres/chapitre-couche-physique.tex}
\input{chapitres/chapitre-protocole-can.tex}
\input{chapitres/chapitre-gestion-erreurs.tex}
\input{chapitres/chapitre-simulation-nprt.tex}
\input{chapitres/chapitre-calcul-frequence.tex}
\input{chapitres/chapitre-calcul-bit.tex}
\input{chapitres/chapitre-can-fd.tex}
\input{chapitres/notes.tex}
