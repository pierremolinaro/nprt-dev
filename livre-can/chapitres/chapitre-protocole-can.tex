...
\begin{figure}[h]
  ...
  \draw (3 * \canbitwidth, -.75) node[left] {\cancommentstyle \emph{Le contrôleur 1 perd l'arbitrage}} ;
  \draw (4.5 * \canbitwidth, -.1) [<-] -- ++ (0, -.9) ;
  \draw (5 * \canbitwidth, -1.25) node[left] {\cancommentstyle \emph{Le contrôleur 3 perd l'arbitrage}} ;
  \end{tikzpicture}
